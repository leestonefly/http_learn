...
function _aMC(t) {
    for (var e = t, n = -1; e = e.parentNode;) if (n = parseInt(e.getAttribute("id")), n > 0) return n
}
...
function c(t) {
    ...
    !e || "p5" in t || (t.p5 = e);
    var n = window.document.location.href, i = "", o = "", s = "",
    ...
    if (window.bds && bds.comm) {
        var c = bds.comm.ubsurl + "?q=" + bds.comm.queryEnc + i + s + "&rsv_sid=" + bds.comm.sid + "&cid=" + bds.comm.cid + "&qid=" + bds.comm.queryId + "&t=" + (new Date).getTime();
        ...
        c += "&rsv_ssl=" + ("https:" === location.protocol ? 1 : 0), c += "&path=" + encodeURIComponent(n), c += "&rsv_did=" + (bds.comm.did ? bds.comm.did : ""), a.src = c
    }
    return !0
}
...
function ns_c_pj(t, e) {
    var n = encodeURIComponent(window.document.location.href), i = "", o = "", s = "",
    ...
    if (s = "&mu=" + n, src = nsclickDomain + "/v.gif?pid=201&" + (e || "") + i + "path=" + n + "&wd=" + wd + "&rsv_sid=" + (bds.comm.ishome && bds.comm.indexSid ? bds.comm.indexSid : bds.comm.sid) + "&rsv_did=" + a + "&t=" + (new Date).getTime(), "undefined" != typeof Cookie && "undefined" != typeof Cookie.get) Cookie.get("H_PS_SKIN") && "0" != Cookie.get("H_PS_SKIN") && (src += "&rsv_skin=1"); else {
        var r = "";
        try {
...
function initPreload(t) {
    ...
    function r(t) {
        function e(t) {
            if (document.all) $("style[data-for='result']").get(0).styleSheet.cssText += t; else {
        ...
        function n() {
            H.css({
                ...
                opacity: .95
            }), B || (e(".slowmsg{z-index:301;background-color:#fff;border:1px solid #f0f0f0;position:fixed;_position:absolute;top:144px;left:212px;height:95px;width:360px;box-shadow:0 0 5px rgba(0,0,0,0.05)}.slowmsg .ball{width:40px;margin:41px auto 0;position:relative;}.slowmsg .b{left:20px;position:absolute;width:10px;height:10px;-moz-border-radius: 50%;-webkit-border-radius: 50%;border-radius: 50%;}"), B = $('<div class="slowmsg"><div class="ball"><div class="b"/><div class="b"/><div class="b"/></div></div>'), B.find(".b").each(function (t, e) {
                var n = [[0, 40], [20, 20], [40, 0]][t], i = ["rgb(55,137,250)", "rgb(99,99,99)", "rgb(235,67,70)"],
                    o = 0;
                $(e).css({"background-color": i[t]}), function s() {
                    return F ? ($(e).animate({left: n[o % 2]}, {
                        duration: 800,
                        easing: "swing",
                        progress: function (n, s) {
                            s >= .5 && $(e).css({"background-color": i[(o + t) % 3]})
                        },
                        complete: function () {
                            s()
                        }
            ...
            })), B.appendTo(Ye), ns_c({pj_name: "loading_msg"})
        }
        ...
        if (!V) {
            ...
            H || (H = $("<div id='_mask'/>")), H.css({
                ...
                top: t.top + "px",
                left: "0"
            }), V = !0, H.width(Ye.width()), H.height(Math.max(o, Ye.height()) - t.top), H.appendTo(Ye), $(window).scrollTop(), F = setTimeout(n, 3e3), Q = setTimeout(i, 7e3), G = function () {
                F && (clearTimeout(F), F = setTimeout(n, 3e3)), Q && (clearTimeout(Q), Q = setTimeout(i, 7e3))
            }
        }
    }

    function d() {
        H && V && (V = !1, H.remove(), B && B.remove(), F && (clearTimeout(F), F = !1), W && W.remove(), Q && (clearTimeout(Q), Q = !1))
    }

    function l(t, e, n) {
        n || (n = 0);
        var i = t.length;
        for (0 > n && (n = i + n); i > n; n++) if (t[n] === e) return n;
        return -1
    }

    function u(t, e, n) {
        var i = e.find("script:not([src])"), o = 0, s = $.globalEval;
    ...
    function p(t, e) {
        ...
        if (!p.__init) {
            ...
            p.prototype.clone = function (t) {
                ...
                if ("object" == typeof t) for (var i in t) t.hasOwnProperty(i) && l(o, i) >= 0 && e.p(i, t[i]);
                return e
                ...
                var e = n(this.params);
                if ("object" == typeof t) for (var i in t) t.hasOwnProperty(i) && (e[i] = t[i]);
                var o = "";
                e.wd = $.limitWd(e.wd);
                ...
                for (var e = 0; e < i.length; e++) {
                    var n = i[e];
                    if ("pn" == n) {
                        var o = this.p(n) ? this.p(n) : "0", s = t.p(n) ? t.p(n) : "0";
                        if (o != s) return !1
        ...
        if (this.params = {}, !e) {
            Ee = we.serializeArray();
            for (var a = 0; a < Ee.length; a++) this.p(Ee[a].name) || this.p(Ee[a].name, Ee[a].value)
        }
    ...
    function f(t) {
        ...
        function m() {
            var t = Math.random(),
                e = /21340|21339|23752|23753|23754|23755|23756|23757|23758|25667|25668|25745|25746|26122|26123/,
                s = t > .51 && .52 > t;
            S = S || bds.comm.bfe_sample;
            var a = S && t > .6 && .9 > t;
            if (t > .51 && .52 > t || e.test(bds.comm.sid) && t > 0 && .2 > t || bds.comm.intrSid || a) {
                e.test(bds.comm.sid) && (s ? n("issam", 2) : n("issam", 1)), a && (n("issam", 3), n("bfesam", bds.comm.bfe_sample)), i(), h(C), b(C), n("srvInfo", f()), n("sysv", navigator.appMinorVersion), r(), x.fire();
        ...
        function p(t) {
            C = t, t.find("img").one("load", function () {
                var t = $(this).offset(), i = t.top, o = t.left, s = "";
                if (I > i && i > 0) {
                    e("fs");
                    var a = _.fs - _.dom;
        ...
        function f() {
            var t, e, n = $.parseJSON(bds.comm.speedInfo), i = [];
            for (var o in n) {
                if (t = n[o], e = t.ModuleId + "_" + t.TimeCost + "_" + t.TimeSelf + "_" + t.Idc, t.hasOwnProperty("SubProcess")) for (var s in t.SubProcess) e += "," + t.SubProcess[s].ProcessId + "_" + t.SubProcess[s].TimeCost + "_" + t.SubProcess[s].isHitCache + "_" + t.SubProcess[s].Idc;
                i.push(e)
            }
        ...
        function b(t) {
            var e = {}, i = [], o = t.find("#content_left,#con-ar").children("*[tpl]"), s = "";
            if (o.length > 0) for (var a = 0; a < o.length; a++) s = o.eq(a).attr("tpl"), e.hasOwnProperty(s) || (e[s] = 1, i.push(s));
        ...
        var v = {product_id: 45, page_id: 317, page_type: 0}, w = {}, _ = {st: 0, pt: 0, net: 0, dom: 0, fs: 0}, y = [],
            x = $.Callbacks(), k = {}, T = null, C = null, S = null, I = 600;
        return l(), {trigger: d, mark: e, setParam: n, onSendlog: g, bindImgLoad: p, destroy: c, init: u}
    }
    ...
    function b() {
        if (bds.comm.seinfo) {
            bds.comm.seinfo.rsv_pre = encodeURIComponent(g()), bds.comm.seinfo.rsv_reh = reh_rec(), bds.comm.seinfo.rsv_scr = scr_rec();
            var t = null;
            ...
            if (t && (bds.comm.seinfo.rsv_skin = t), bds.comm.seinfo.rsv_psid = $.getCookie("BIDUPSID"), bds.comm.seinfo.rsv_pstm = $.getCookie("PSTM"), bds.comm.seinfo.rsv_idc = function () {
                ...
                for (var n = 0, i = t.length; i > n; n++) if (9540 == t[n].ModuleId) return t[n].Idc || "";
                return ""
        ...
        !function () {
            var t = Math.random(), e = function () {
                function t() {
                    ...
                    var a = $.when.apply($, i);
                    a.always(function () {
                        var n = "//www.baidu.com/nocache/fesplg/s.gif?log_type=hm&type=ssl&", i = t.join("&"),
    ...
    function w(t, e) {
        var n, i = e.prefix, o = t.attr("href");
        ...
        if (o && (n = o.match(/^\/*(link|baidu.php)\?(.*)$/), n = o.match(e.regex)), !(n && n[2] && n[2].match(/&(wd|word)=/))) {
            if (o && n) {
                ...
                var a = oe.getLinkParams(o);
                a && ("https:" === ne.protocol && /Chrome|Safari/.test(navigator.userAgent) && (i = i.replace(/^http:\/\/www\.baidu\.com/, "https://www.baidu.com")), o = i + "/" + n[1] + "?" + n[2] + "&" + a, t.attr("href", i + "/" + n[1] + "?" + n[2] + "&" + a), t.click(function () {
    ...
    function _(t) {
        if (!window.__disable_is2 || $.trim(t) != $.trim($e.val())) {
            ...
            if (0 != pageState && !window.__disable_kw_tip) if (ke || (ke = $('<div id="kw_tip" style="width:initial" unselectable="on" onselectstart="return false;" class="s_ipt_tip"/>').insertBefore($e), ke.parent().click(function (t) {
                var e = $e.get(0);
    ...
    function T(t, e) {
        ...
        if (e.force || h(e, {utime: (new Date).getTime() - je}), !e || !e.loaded) return !1;
        ...
        Re.hide(), oldEnv = Ne, Ne = t, Be = ze, ze = e, bds.comm.cur_disp_query = t.p("wd"), S(), bds && bds.se && bds.se.certification && bds.se.certification.data && (bds.se.certification.data = []), 0 == pageState && P(t), m(function () {
            he()
        }), bds.clearReady(), Re.empty();
        var o = e.html;
        if (X.use_cache_repeatedly && (o = o.clone()), m(function () {
            ...
            var s = Ne.buildSyncSearchUrl({jmp: "jsver", _vr: Math.random()});
        ...
        m(function () {
            ...
            if (t.size()) {
                var e = $("#s_tab");
                e.size() ? e.replaceWith(t) : t.insertBefore(Re)
            }
        });
        var a = !1;
        !function () {
            var t = o.find("#con-at"), n = $("#con-at"), i = n.children().children();
            if (i.size()) if (t.children().size()) {
                var s = t.children().children();
                i.attr("cq") != s.attr("cq") || i.attr("srcid") != s.attr("srcid") || e.force && oldEnv && oldEnv.equals(Ne) || !Ne.p("cq") || !Ne.p("srcid") || 1 == Ne.p("_trf") ? (n.remove(), $(window).trigger("top_result_removed"), u(Re, t, "insertBefore")) : a = !0
            } else n.remove(), $(window).trigger("top_result_removed"); else t.children().size() && u(Re, t, "insertBefore")
        }();
        var r = o.find("#container");
        if (e.pdc.bindImgLoad(r), u(Re, r), !$("#footer").size()) {
            var c = o.find("#footer").children();
            u(Re, c)
        }
        m(function () {
            var t = (new Date).getTime();
            o && $.globalEval(o.find("#jsMerge").html()), h(e, {jsmergetime: (new Date).getTime() - t})
        }), bds && bds.comm && bds.comm.templateName == bds.comm.resTemplateName ? bds.comm.seinfo && (bds.comm.seinfo.rsv_tpfail = 0) : bds.comm.seinfo && (bds.comm.seinfo.rsv_tpfail = 1), 0 != pageState && bds && bds.util && bds.util.setContainerWidth && bds.util.setContainerWidth(), document.title = t.p("wd") + "_百度搜索", Re.show(), d(), h(e, {domtime: (new Date).getTime() - n}), h(e, {waittime: (new Date).getTime() - Te}), e.pdc.mark("dom"), $(window).trigger("swap_dom_ready", [e, t]), window.__lazy_foot_js ? setTimeout(function () {
            C(t, e, n)
        }, 0) : C(t, e, n), a ? window.scrollTo(i[0], i[1]) : window.scrollTo(0, 0), $(window).trigger("scroll"), swap_wait = !1
    }
    ...
    function C(t, e, n) {
        ...
        n || (n = 0), e && (i = e.html), m(function () {
            ...
            var t = (new Date).getTime();
            e && e.base64 && (e.base64.setDomLoad("left"), e.base64.setDomLoad("right")), h(e, {base64time: (new Date).getTime() - t})
            ...
            var t = (new Date).getTime();
            bds.doReady(), h(e, {bdstime: (new Date).getTime() - t})
        }), m(function () {
            var t = (new Date).getTime();
            i && $.globalEval(i.find("#ecomScript").html()), h(e, {ecomtime: (new Date).getTime() - t})
        }), m(function () {
            var t = (new Date).getTime();
            ...
            }, 1200)), h(e, {tiptime: (new Date).getTime() - t})
        }), m(function () {
            var t = (new Date).getTime();
            window.initResultClickLog(), h(e, {clicktime: (new Date).getTime() - t})
        }), m(function () {
            h(e, {
            ...
            $(window).trigger("swap_end", [e, t]), q(), je = (new Date).getTime(), e && e.pdc && (e.pdc.mark("js"), e.pdc.trigger("swap_end"))
        })
    }
    ...
    function I() {
        De && Le && (clearTimeout(De), De = setTimeout(Le, Z))
    }
    ...
    function D(t, e, n) {
        return function (e) {
            var i = $.extend({}, e);
            if (t && !t.confirm) {
                bds.comm.cur_query = t.real_wd, !bds.comm.supportis && t && (n = t.pstg || 0), t.confirm = !0, De = !1, Le = null;
                var o = {};
                o.is_referer = ie, o.is_xhr = "1";
                var s = new p(a(oe.getQueryString()), !0);
                t.env.equals(s) || t.env.clone({wd: t.prw}).equals(s) || oe.setUrl(t.env), ie = ne.protocol + "//" + ne.host + ne.pathname + ne.search, t.seq ? t.seq++ : t.seq = 1, t.pdc && (20 != n && bds.comm.supportis && t.pdc.mark("st"), t.pdc && t.pdc.setParam && t.pdc.setParam("cus_pstg", n), t.force && t.pdc.setParam("f4s", 1), t.pdc.trigger("confirm"), window.PRE_CONN.startTimer()), m(function () {
                    $(window).trigger("confirm", [t, n])
                });
                var r = "/s?ie=utf-8&csq=" + t.seq + "&pstg=" + n + (i.tipConfirm ? "&_cktip=1" : "") + "&mod=2" + (bds.comm.supportis ? "&isbd=1" : "") + "&cqid=" + t.qid + "&istc=" + ((new Date).getTime() - t.startTime) + "&ver=" + bds.comm.baiduis_verify + "&chk=" + t.chk + "&isid=" + ve + "&" + t.env.buildQueryString() + (t.force ? "&f4s=1" : "") + ("function" == typeof Ke ? "&_ck=" + Ke(t.env.p("wd")) : "");
                if (bds.comm.indexSid && (/9998_/.test(bds.comm.indexSid) && "https:" === ne.protocol && (bds.comm.indexSid = bds.comm.indexSid.replace("9998", "8499")), r += "&rsv_isid=" + bds.comm.indexSid), t.no_predict && (r += "&isnop=" + (1 >= fe ? 0 : 1)), t && t.pstg && (r += "&isctg=" + t.pstg), fe = 0, Oe && Oe.getRsvStatus) try {
                    r += "&rsv_stat=" + Oe.getRsvStatus(t.env.p("wd"))
                } catch (c) {
                }
                if (Fe.done(function () {
                    Oe.getStat("rsv_sug6") && (r += "&rsv_sug6=" + Oe.getStat("rsv_sug6"), bds.comm.seinfo && (bds.comm.seinfo.rsv_sug6 = Oe.getStat("rsv_sug6"))), Oe.getStat("rsv_sug7") && (r += "&rsv_sug7=" + Oe.getStat("rsv_sug7")), Oe.getStat("rsv_sug9") && (r += "&rsv_sug9=" + Oe.getStat("rsv_sug9")), Oe.getStat("rsv_bp") && (r += "&rsv_bp=" + Oe.getStat("rsv_bp"))
                ...
                bds.comm.confirmQuery = bds.comm.query, bds.comm.confirmQid = bds.comm.qid, b(), ve = t.qid, Fe.done(function () {
                    20 == n ? Oe.updateInitData() : 22 == n || bds.comm.supportis || n >= 0 && 5 >= n && Oe.updateInitData(), Oe.clearStat()
    ...
    function L(t) {
        ...
        try {
            ...
            var n, i = new p, o = $(this).serializeArray();
            for (n = 0; n < o.length; n++) i.p(o[n].name, o[n].value);
            if (e && !$.trim($e.val()) ? (i.p("wd", e), i.p("rsv_dq", 1)) : $.trim($e.val()) && i.p("wd", $e.val()), i.p("nojc") && i.p("nojc", ""), ze) {
                if (i.equals(ze.env.clone({wd: ze.real_wd})) && !ze.force) return D(ze, Be, 22)(), ze.force = !0, _(""), k(ze), !1;
                ze.env.p("rsv_spt") && i.p("rsv_spt", ze.env.p("rsv_spt"))
            }
            oe.submit(i, !!t)
        } catch (s) {
        }
    ...
    function R(t) {
        ...
        t && $.extend(e, t);
        var n, i = e.env, o = e.force, s = e.no_predict, a = e.shouldShow, c = e.use_cache;
        if (i && i.p("wd") && i.hashCode() && (!se && 1 != Cookie.get("ISSW") || o || !s) && (!re && 1 != Cookie.get("ISSW") || o || s)) {
            if (c && (n = ee.hasCache(i, {loaded: !0}))) return void(a && (ze && n.env.clone({wd: n.real_wd}).equals(ze.env.clone({wd: ze.real_wd})) || (n.force = e.force, n.no_predict = e.no_predict, n.pdc.init(), n.force && (n.pdc.mark("st"), window.bds && bds.comm && !bds.comm.supportis && (n.pdc.mark("net"), n.pdc.setParam("cus_hitpreload", 1))), T(i, n)), _(e.no_predict && 6 != e.pstg ? "" : n.real_wd), k(n)));
            o && a && s && r(), n = {
                env: i,
                cftime: 0,
                no_predict: s,
                ...
                log: {
                    ctime: (new Date).getTime() - je,
                    wd: i.p("wd"),
                    ntime: 0,
                    stat: 0,
                    used: 0,
                    rtime: 0,
                    utime: o ? (new Date).getTime() - je : 0,
                    res: 0
                }
            }, n.pdc = f(n), e.pstg > 0 && (n.pstg = e.pstg), n.force && n.pdc.mark("st"), n.base64 = isbase64(n.pdc), Ae.push(n.log), pe++, fe++, O(n)
        }
    }

    function A() {
        var t = [];
        return Pe && (t = $.map(Pe.slice(0, 2), function (t) {
            return t.value
        })), t.join("	")
    }
    ...
    function j(t, e) {
        e ? (re = !0, sn && (clearTimeout(sn), sn = !1), sn = setTimeout(function () {
            re = ce
    ...
    function O(t) {
        var e, a, r = t.env, c = {};
        c.is_referer = ze && ze.env ? ze.env.buildSyncSearchUrl() : He.replace(/\#.*$/, ""), $.extend(c, r.buildHeaders()), c.is_xhr = "1", window.bds && bds.comm && bds.comm.cur_query ? r.p("bs", bds.comm.cur_query) : r.p("bs", ""), window.bds && bds.comm && bds.comm.cur_disp_query && (c.is_pbs = encodeURIComponent(bds.comm.cur_disp_query));
        var d = t.no_predict || !bds.comm.supportis ? 1 : 11, l = t.pstg;
        if (!(1 == d && 1 == l || 11 == d && 3 == l || 11 == d && 6 == l || 1 == d && 4 == l)) {
            var u = "ie=utf-8" + (bds.comm.newindex ? "&newi=1" : "") + (be.sid ? "&sid=" + encodeURIComponent(be.sid) : "") + (be.tnp ? "&tnp=" + encodeURIComponent(be.tnp) : "") + "&mod=" + (t.no_predict || !bds.comm.supportis ? "1" : "11") + (bds.comm.supportis ? "&isbd=1" : "") + "&isid=" + ve + "&" + r.buildQueryString() + "&rsv_sid=" + bds.comm.indexSid + "&_ss=1&clist=" + encodeURIComponent(ee.getCacheList()) + "&hsug=" + encodeURIComponent(A()) + (t.force ? "&f4s=1" : "") + "&csor=" + getCursortPosition($e.get(0));
            t.pstg && (u += "&pstg=" + t.pstg);
            var m = "/s?" + u;
            if (m += "&_cr1=" + s(m), !t.no_predict) for (a = ee.find(function (t) {
                return t.loaded || t.no_predict ? void 0 : !0
            }), e = 0; e < a.length; e++) ee.deleteCache(a[e]);
            if (!(t.no_predict && !t.force && (a = ee.find(function (t) {
                return t.force && r.equals(t.env) ? !0 : void 0
            }), a.length > 0))) {
                if (t.force && t.shouldShow) {
                    var p = !1, f = (new Date).getTime();
                    if (a = ee.find(function (e) {
                    ...
                    for (e = 0; e < a.length; e++) ee.deleteCache(a[e])
                }
                var b, g = function (e, n, i) {
                    if (0 == n) v(e, i), t.pdc && (t.pdc.setParam("cus_srv", bds.se.mon.srvt), t.pdc.setParam("bsi", Cookie.get("__bsi"))); else if (1 == n) try {
                        var o = 1 * new Date;
                        t.b64ildata = $.parseJSON(e), t.base64.ilparseTime = 1 * new Date - o, t === ze && (t.base64.inline(t.b64ildata), t.base64.ilrenderTime = 1 * new Date - o), $(t).one("swap_begin", function () {
                            this.base64.inline(this.b64ildata, this.html.get(0))
                        })
                    } catch (s) {
                    } else 2 == n && t.base64 && (t.base64.ilsum = e)
                }, v = function (e, s) {
                    if (s && "302" == s.status || e && $.trim(e).indexOf("<div>") > 10) return void(t.force ? (n(11), E(r)) : ee.deleteCache(t));
                    ...
                    var m = parseInt(a.find("#__status").eq(0).html()),
                        ...
                        f = parseInt(a.find("#__redirect").eq(0).html()), b = {};
                    try {
                        b = $.parseJSON(a.find("#__sugPreInfo:eq(0)").html() || "{}") || {}
                    } catch (u) {
                    }
                    ...
                    var g = !1;
                    (r.p("wd") == o($e.val()) || t.force) && t.shouldShow && (g = !0), t.real_wd && (t.prw = r.p("wd"), r.p("wd", t.real_wd));
                    var v = a.find("#__queryId").html(), w = a.find("#__querySign").html();
                    t.querySign = w, h(t, {stat: m ? m : 0}), bds.comm.isDebug && $("#isDebugInfo").html(a.find("#__isDebugInfo").html()), v && (t.qid = v);
                    var C = a.find("#__chk").html();
                    if (t.chk = C ? C : 0, !e || !v && !p && !f && !m || !w && t.force) return t.force ? (r.p("__eis", 1), r.p("__eist", e ? e.length : 0), r.p("real_wd", t.real_wd), n(13), void E(r)) : void ee.deleteCache(t);
                    if (p > 0 && j(1e3 * p, !t.no_predict), -11 == m) {
                        ...
                        S.force = t.force, y(), _(S.real_wd), k(S), ee.deleteCache(t), t = S, ze && t.real_wd == ze.real_wd || (g = !0)
                    } else {
                        if (0 > m) {
                            if (1 == f && t.force) return h(t, {redirect: 1}), n(14), void E(r);
                            if (x(), -12 == m && b && b.wait_time > 0) {
                                var I = t.env.clone();
                                Ge = setTimeout(function () {
                                    R({env: I, force: !1, use_cache: !0, no_predict: !0, shouldShow: !1, pstg: 6})
                                }, b.wait_time)
                            }
                    ...
                    for (var D = ee.find(function (e) {
                        return !e.loaded && e !== t && e.no_predict && r.equals(e.env) ? (e.shouldShow && (g = !0), e.force && (t.force = !0, t.no_predict = !0), !0) : void 0
                    }), L = 0; L < D.length; L++) ee.deleteCache(D[L]);
                    return t.backup_request_timeout && clearTimeout(t.backup_request_timeout), t.loaded = !0, bds.comm.supportis || g ? void((g && t !== ze || t.force) && (y(), t.shouldShow = !1, -11 == m ? t.pdc.init() : t.pdc.mark("net"), T(r, t))) : !0
                };
                b = $.ajax({dataType: "parts", url: m, headers: c, delimiter: "</*3*/>"}), b.parts(function (t, e) {
                    g(t, e, b)
                }), b.fail(function (e, i) {
                    t.force && t.shouldShow && "abort" != i && t.env && (n(12), ne.replace(t.env.buildSyncSearchUrl() + "&rsv_jmp=fail")), ee.deleteCache(t)
                }), t.xhr = b, ee.addCache(t)
            }
        }
    }

    function q() {
        Ae = [], pe = 0, en = !1, clearTimeout(tn)
    }

    function M() {
        window.index_off && window.index_off(), xe[0] !== ye[0] && xe.val(""), $e = ye, pageState = 1, bds.comm.ishome = 0, bds.comm.cur_query = bds.comm.query, Ne = new p, ze = {
            env: Ne,
    ...
    function P(t) {
        window.index_off && window.index_off(), xe.get(0) !== ye.get(0) && (xe.val(""), ye.val(t.p("wd"))), $e = ye, pageState = 1, bds.comm.ishome = 0, Fe.done(function () {
            qe !== Me && (qe.stop(), Me.hide(), Me.setKey(t.p("wd")), Me.start())
        }), bds.util.setContainerWidth(), $(window).trigger("index_off", t)
    }

    function U() {
        rn = !1, cn = !1, ln = [], clearTimeout(un), un = !1
    }

    function N(t) {
        rn || (rn = {x: t.pageX, y: t.pageY}), dn = {
            x: t.pageX,
            y: t.pageY
        }, cn || rn.x == t.pageX || rn.y == t.pageY || (cn = !0, ln = [rn], z())
    }

    function z() {
        ln.push(dn);
        var t = ln.length;
        if (Math.pow(dn.x - rn.x, 2) + Math.pow(dn.y - rn.y, 2) >= Math.pow(me, 2) || t * ue >= le) {
            var e = Oe, n = bds.comm.supportis ? 1 : 2;
            if (n && e && e.data() && e.data()[0] && e.visible()) {
                var i = (new p).clone({wd: e.data()[0].value});
                R({env: i, force: !1, no_predict: !0, use_cache: !0, shouldShow: !1, pstg: 1}), n--
            }
            if (n && e && e.data() && e.data()[1] && e.visible()) {
                var i = (new p).clone({wd: e.data()[1].value});
                R({env: i, force: !1, no_predict: !0, use_cache: !0, shouldShow: !1, pstg: 1}), n--
            }
            if (!bds.comm.supportis && n && $.trim($e.val()) && (!ze || ze.env.p("wd") != $.trim($e.val()))) {
                var i = (new p).clone({wd: $.trim($e.val())});
                R({env: i, force: !1, no_predict: !0, use_cache: !0, shouldShow: !1, pstg: 1}), n--
            }
    ...
    document.write = document.writeln = function () {
        ...
        return t ? t && !e && Ne ? Ne.p(t) : void(t && e && Ne && (Ne.p(t, e), ne.href = Ne.buildSearchUrl())) : void 0
    };
    var H, B, F, W, Q, G, V = !1;
    !function () {
        var t = $.globalEval;
    ...
    window.setSugKey = function (t) {
        $e && t && (Me && Me.setKey ? Me.setKey(t) : $e.val(t))
        ...
        var t = $(this).closest(".result"), e = $("h3 a:first", t), n = $(".c-abstract:first", t),
            i = $(".c-fanyi-abstract", t).val(0).html(), o = $(".c-fanyi-title", t).val(0).html();
        $(".c-fanyi-abstract", t).val(0).html(n.html()), $(".c-fanyi-title", t).val(0).html(e.html()), e.html(o), n.html(i)
    }));
    var X = {use_cache_repeatedly: !0, index_form: "#form", kw: "#kw", result_form: "#form"};
    t && $.extend(X, t);
    var K = 15, Y = 6e4, Z = window.__confirm_timeout ? window.__confirm_timeout : 1e4,
        te = bds.comm.supportis ? 4 : 10, ee = function () {
            function t(t) {
                ...
                find: function (t) {
                    ...
                    function i(t) {
                        ...
                        return (o = t.p("wd")) ? ($.grep(e, function (e) {
                            return n.loaded && !e.loaded ? !1 : void(t.equals(e.real_wd ? e.env.clone({wd: e.real_wd}) : e.env) && (i = e))
                        }), i ? i : null) : !1
                    }

                    n || (n = {});
                    var o = i(t);
                    return o && (new Date).getTime() - o.startTime > Y && (this.deleteCache(o), o = null), o
        ...
        }(), ne = document.location, ie = ne.protocol + "//" + ne.host + ne.pathname + ne.search, oe = {
    ...
    !function () {
        ...
        function s(t) {
            var e = new p(a(oe.getQueryString()), !0);
            e.hashCode() ? 0 == pageState && P(e) : 0 != pageState ? ne.replace(ne.pathname + ne.search.replace(/([?&])isidx=[^&*]&?/, "$1")) : ne.search != ne.search.replace(/([?&])isidx=[^&*]&?/, "$1") && ne.replace(ne.pathname + ne.search.replace(/([?&])isidx=[^&*]&?/, "$1")), oe.onurlchange(e, t)
        }

        var r = "onhashchange" in window, c = "onpopstate" in window;
        window.__disable_popstate && (c = !1);
        var l = ne.pathname.length > 1 ? ne.pathname : "/s";
        (navigator.userAgent.match(/MSIE (6|7)/) || document.documentMode < 8) && (r = !1, c = !1), X.disable_popstate && (c = !1), r || c || e();
        var u = function () {
            var e = "";
            return function (n, i) {
                i && (e = i.buildQueryString(), ne.hash = e), (n || e != t()) && (s(n), e = t())
            }
        }();
        oe.setUrl = function (t) {
            c ? m(!1, t) : r && u(!1, t)
        };
        var m = function () {
            var t = n();
        ...
        oe.getQueryString = function () {
            ...
            var e = t();
            /wd=/.test(e) && (c ? (window.history.replaceState(null, "", l + "?" + e), m()) : r ? u() : ne.replace(l + "?" + e))
        }, oe.support = function () {
            return (c || r) && 1 != Cookie.get("ISSW") && !window.__disable_preload
        }, oe.getLinkParams = function (e) {
            if (!c) {
                var o = t();
                return "" == o && (o = n()), i(o, e)
            }
            ...
            return !1
        }, oe.clickResultLink = function (t, e, n) {
        ...
        }, oe.submit = function (t, e) {
            setTimeout(function () {
                c ? (window.history.pushState(t, "", t.buildSyncSearchUrl()), m(e)) : r ? (ne.href = t.buildSearchUrl(), u(e)) : ne.href = t.buildSyncSearchUrl()
            }, 0)
        }, window.changeUrl = function (t) {
            var e = new p(a(t));
            oe.submit(e, !0)
        }
    }(), oe.onurlchange = function (t, e) {
        Fe.done(function () {
            Oe.setKey(t.p("wd")), Oe.hide()
        }), Te = (new Date).getTime(), $e.val(t.p("wd")), _("");
        var n = !0;
        e && ze && ze.env && ze.env.equals(t) && (n = !1), R({env: t, force: !0, use_cache: n, no_predict: !0})
    };
    var se = X.disable ? X.disable : !1;
    window.__disable_preload && (se = !0);
    var ae = se, re = !1;
    window.__disable_predict && (re = !0);
    var ce = re, de = bds.comm.switchAddMask ? bds.comm.switchAddMask : !1;
    de || (de = window.__switch_add_mask ? window.__switch_add_mask : !1), de = !0;
    var le = (bds.comm.preloadMouseMoveDistance ? bds.comm.preloadMouseMoveDistance : 5, 300), ue = 50, me = 80, pe = 0,
        fe = 0, he = function () {
        }, be = a(ne.search);
    oe.support() || (!function () {
        function t() {
    ...
    for (var ge = Cookie.get("BAIDUID", "nobdid").split(":")[0], ve = ge.substr(0, 6) + ge.substr(ge.length - 5, 5) + parseInt(99999 * Math.random()); ve.length < 16;) ve += "0";
    ve = encodeURIComponent(ve);
    var we, _e, ye, xe, $e, ke;
    ye = xe = $e = $(X.kw);
    var Te, Ce, Se, Ie, De, Le, Re = $("#wrapper_wrapper"), Ae = [];
    window.__async_strategy, we = $(X.index_form), "_blank" == we.attr("target") && (window.__disable_index_predict = !0, ae = se = !0);
    var Ee = we.serializeArray();
    _e = $(X.result_form);
    var je = (new Date).getTime();
    window.pageState = 0;
    var Oe, qe, Me, Pe, Ue, Ne = null, ze = null, He = document.location.href, Be = !1, Fe = $.ajax({
        dataType: "script",
        cache: !0,
    ...
    !function () {
        window.PDC_ASYNC = {
            setParam: function (t, e) {
                ...
                var e = "//www.baidu.com/nocache/fesplg/s.gif?log_type=linksp", n = "";
    ...
    var Qe = function (t) {
        ...
        function o(t) {
            try {
                var e = 0, n = Math.max.apply(null, t), i = 10, o = 60, s = 4, a = 40, r = Cookie.get("ispeed_lsm"),
                    c = 0, d = new Date, l = 0;
    ...
    Fe.done(function () {
        Oe = qe = Me = bds.se.sug({
            ...
            (9 == t.keyCode || 39 == t.keyCode && e == this.value.length) && bds.comm.supportis && ze && ke.text() && (t.preventDefault(), ze.real_wd != this.value && ($e.val(ze.real_wd), Oe.check()), Oe.show(), _(""), D(ze, Be, 22)({tipConfirm: !0}))
        }), Oe.on("start", function () {
            We = "focus"
        }), $(window).on("blur", function () {
            Oe.hide()
        }), $(document).on("click", function (t) {
            return 2 == t.isTrigger || 3 == t.isTrigger ? !1 : void Oe.hide()
        });
        var t, e;
        Oe.on("inputChange", function (n, i) {
            if (!(window.__sam_his_nopredict && window.bds && bds.comm && 0 == bds.comm.supportis)) {
                if (t || (t = $e.val()), _(""), U(), clearTimeout(Ge), clearTimeout(an), 0 == pageState && window.__disable_index_predict || se || re || Qe.isSlow()) return void Oe.setMaxNum(10);
                Oe.setMaxNum(te);
                var o = new p({pn: "", wd: i.value});
                if (bds && bds.comm && bds.comm.logFlagSug && 1 === bds.comm.logFlagSug && o.p("rsv_slog", "ipt_change"), 0 == pageState && bds.comm.supportis && $.trim($e.val())) {
                    P(o);
                ...
                if (window.__restart_confirm_timeout && I(), We = "input", Te = (new Date).getTime(), e && (clearTimeout(e), e = !1), "" == $.trim(i.value)) return void x();
                if (Pe = i.checkStore(), !/^[a-zA-Z0-9~!@#$%^&*()_+=-]$/.test(i.value)) {
                    var a = $e.val(), r = i.imt.getLog();
                    r.length > 0 && r[r.length - 1].type.indexOf("link") > -1 && o.p("_sglink", "1");
                    var c = i.imt.diffLog();
                    c && c.length > 1 && (c = c.slice(-15).join("."), o.h({is_params: {imes: encodeURIComponent(c)}})), !window.__disable_is2 && t.length > a.length && 0 === t.indexOf(a) ? e = setTimeout(function () {
                        R({env: o, use_cache: !0, force: !1, pstg: 5, shouldShow: bds.comm.supportis}), e = !1
                    }, 250) : R({env: o, use_cache: !0, force: !1, pstg: 5, shouldShow: bds.comm.supportis})
                }
                t = a
            }
        }), Oe.on("selectSug", function (t, e, n, i) {
            if (_(""), clearTimeout(Ge), !(0 == pageState && window.__disable_index_predict || se || re || Qe.isSlow())) if (-1 == n) {
                ze && Oe.setVisibleSug(ze.real_wd);
                ...
                R({env: o, force: !1, use_cache: !0, no_predict: !0, shouldShow: s, pstg: 3})
            }
        }), Oe.on("render", function () {
            ze && Oe.setVisibleSug(ze.real_wd)
        }), Oe.on("dataReady", function (t, e) {
            var n = e && e.queryValue && e.dataCached && e.dataCached[e.queryValue];
            if (n && n.gl) for (var i in n.gl) if (1 * n.gl[i] > 0) {
                var o = new p({pn: "", wd: n.s[i]});
                R({env: o, force: !1, use_cache: !0, no_predict: !0, shouldShow: !1, pstg: 7})
            }
        }), 0 == pageState && Oe.start()
    });
    var Ve, Je, Xe, Ke;
    !function () {
        var t, e = -1, n = 0, i = -1, o = -1, a = -1, r = -1, c = 0;
        Ve = function (e) {
            if (e) {
        ...
        D(ze, Be, 22)()
    }), v({prefix: "http://www.baidu.com", regex: /^\/*(link)\?(.*)$/}), v({
        ...
        var t = $(this), e = t.attr("href"), n = {"http://v.baidu.com": "/?fr=bd"};
        n && n.hasOwnProperty(e) && t.attr("href", e + n[e])
    }), $(document).delegate("a", "mousedown", function () {
        var t = $(this), e = t.attr("href"), n = new Image, i = "//www.baidu.com/nocache/fesplg/s.gif?log_type=hm",
            o = Math.random();
        if (.01 > o && !/www\.baidu\.com\//.test(e) && /^http/.test(e)) {
            var s = i + "&c_url=" + encodeURIComponent(e), n = new Image, a = "_LOG_" + (new Date).getTime();
            n.onload = function () {
                delete window[a]
            }, window[a] = n, n.src = s
        }
    }), oe.support() && $(document).delegate("a", "click", function () {
            ...
            if (!(e.attr("target") && "_self" != e.attr("target") || e.attr("sync") && "true" == e.attr("sync"))) {
                ...
                if (n && 0 == n.indexOf(t) && (n = n.substring(t.length)), n && (matched = n.match(/^\/*s\?(.*)/)), n && matched) {
                    ...
                    if (i.pn || (i.pn = ""), l(["baidurt", "baiduwb", "baidufir", "SE_baiduxueshu_c1gjeupa"], i.tn) < 0) {
                        ...
                        var s = oe.clickResultLink(e, Ne, i)
                    }
                    return s
                }
            }
        ...
        window._bdlkc >= 1 && ($(document).delegate(".c-container", "mouseenter", function () {
            return function () {
                ...
                2 == window._bdlkc && (n = 100), t = setTimeout(function () {
                    var t = e.find(".t>a"), n = w(t, {prefix: "http://www.baidu.com", regex: /^\/*(link)\?(.*)$/}),
                        i = e.attr("mu") || e.find(".f13 .g").text(), o = /^(http[s]?:\/\/)?([^\/]+)(.*)/,
                        s = i.match(o);
                    n && n.match(ne.protocol) && /www\.baidu\.com\/link/.test(n) && !/bdlkc=1/.test(n) && (s[2] && (i = "http://" + s[2], e.append('<link rel="dns-prefetch" href="' + i + '" />')), $.ajax({
                        url: n + "&bdlkc=1",
                        type: "GET",
    ...
    $(window).on("swap_dom_ready", function (t, e) {
        ...
        e && (window.cfpromise = new $.Deferred, De && (clearTimeout(De), De = !1, Le = null), e.confirm = !1, e.force ? D(e, Be, 20)() : (Le = D(e, Be, 21), De = setTimeout(Le, Z)))
    }), $(window).on("indexOff", function (t, e) {
        Fe.done(function () {
            _(e.p("wd"))
        })
    }), oe.support() && "_blank" != we.attr("target") && Fe.done(function () {
        Oe.setMaxNum(te)
    });
    var tn, en = !1, nn = !1;
    ...
    var on, sn, an;
    $(window).on("swap_end", function (t, e) {
        e || (bds.comm.confirmQuery = bds.comm.query, bds.comm.confirmQid = bds.comm.qid, b()), an = setTimeout(function () {
    ...
    }), bds.comm.resultPage && M(), Ye.delegate("#s_tab a", "mousedown", function () {
        setHeadUrl(this)
    }).delegate("#s_tab a", "focusin", function () {
        setHeadUrl(this)
    }), Re.delegate("#page strong+a,#page a.n", "mouseover", function () {
        R({env: new p(a($(this).attr("href"))), force: !1, use_cache: !0, no_predict: !0, shouldShow: !1, pstg: 4})
    });
    var rn, cn, dn, ln, un;
    Fe.done(function () {
        ...
        var t = new Date;
        t.setTime((new Date).getTime() + 110376e7), Cookie.set("ORIGIN", 2, document.domain, "/", t), Ne ? ne.replace(Ne.buildSyncSearchUrl({_r: Math.random()})) : ne.href = "/"
    }), $(window).scroll(function () {
        var t, e = $("#head"), n = $(window), i = 40, o = e.offset().top, s = function () {
        ...
        if (!(window.__disable_index_predict && 0 == pageState || se || re)) {
...
function user_c(t) {
    var e = "", n = "", i = "", o = "", s = encodeURIComponent(window.document.location.href),
        a = window["BD_PS_C" + (new Date).getTime()] = new Image,
...
function isp_hijack(t) {
    var e, n, i, o = document.getElementById("wrapper"), s = !1;
...
function isbase64(t) {
    ...
    function n(t, e) {
        ...
        if (t = $.grep(t, function (t) {
            ...
            var n = Math.round(t.length / 2), i = [], o = [];
            $.each(t, function (t, e) {
    ...
    function s(t, e, n) {
        ...
        var r = 1 * new Date, c = $.ajax({
            ...
            jsonpCallback: a,
            success: function (t) {
                u[n] = 1 * new Date - r, "right" == e ? S(t) : "left" == e && I(t)
            }
        });
        c.always(function () {
    ...
    var w = function (t, e, n, i) {
        if (i = i ? $(i).find("#" + d[e])[0] : document.getElementById(d[e])) for (var o = i.getElementsByTagName("IMG"), s = 0; s < o.length; s++) {
            var a = o[s].getAttribute(n);
            a && (t.hasOwnProperty(a) && t[a] ? r(o[s], t[a]) : C(o[s]))
        }
    }, _ = function (t) {
        w(f[t], t, "data-b64-id")
        ...
        loadImg: n, setDomLoad: L, end: a, isinline: function () {
            return x
...
!function () {
    ...
    function createPlaceHolder(t, e, n) {
        if (e) t.attr("placeholder", n); else {
    ...
    function recordDefaultQuery(t, e) {
        var n = {query: t, time: (new Date).getTime(), count: 1};
...
!function (t) {
    ...
    function i() {
        function t(a, r) {
            if (!s[a] && !m(a, N)) {
                s[a] = 1;
                var c = q[a];
                c ? (r || !m(a, U) || c.hang) && (i[a] || (i[a] = 1, e.push(a)), R(c.depMs, function (e) {
                    t(e.absId, e.hard)
                })) : o[a] || (o[a] = 1, n.push(a))
            }
        }
    ...
    function s(t, e, n) {
        if (null == n && (null == e ? (n = t, t = null) : (n = e, e = null, t instanceof Array && (e = t, t = null))), null != n) {
            ...
            t ? r(t, e, n) : W[0] = {deps: e, factory: n}
        }
    }
        ...
        if (e && !m(t, P)) {
            ...
            R(n, function (n, i) {
                ...
                l && !H[l] ? (d.res && (c = {
                    ...
                    absId: l,
                    hard: o > i
                }, e.depMs.push(r), e.depMkv[l] = r, s.push(l))) : r = {absId: l}, o > i && e.factoryDeps.push(c || r)
    ...
    function g(e, n, i) {
        ...
        var s = 0;
        R(e, function (t) {
            H[t] || m(t, N) || (h(t, o), (t.indexOf("!") > 0 ? w : v)(t, i))
        }), o()
    }
    ...
    function k(t) {
        function n(n, o) {
            if ("string" == typeof n) {
                if (!i[n]) {
                    var s = T(n, t);
                    if (p(s), !m(s, N)) throw new Error('[MODULE_MISS]"' + s + '" is not exists!');
                    i[n] = q[s].exports
                }
                return i[n]
            }
            if (n instanceof Array) {
                var a = [], r = [];
                R(n, function (n, i) {
                    var o = I(n), s = T(o.mod, t), c = o.res, d = s;
                    if (c) {
                        var l = s + "!" + c;
    ...
    function R(t, e) {
        if (t instanceof Array) for (var n = 0, i = t.length; i > n && e(t[n], n) !== !1; n++) ;
    }

    function A(t, e) {
        var n = t.k || t.name, i = e.k || e.name;
    ...
    var O, q = {}, M = 1, P = 2, U = 3, N = 4, z = {}, H = {require: n, exports: 1, module: 1}, B = k(), F = {
        baseUrl: "./",
        paths: {},
        config: {},
        map: {},
    ...
    n.config = function (t) {
        if (t) {
            for (var e in F) {
                var n = t[e], i = F[e];
                if (n) if ("urlArgs" === e && "string" == typeof n) F.urlArgs["*"] = n; else if (i instanceof Array) i.push.apply(i, n); else if ("object" == typeof i) for (var o in n) i[o] = n[o]; else F[e] = n
            }
            y()
        }
    }, y();
...
bds.amd = {
    ...
    Atom: "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/bundles/atom_4ec866a",
    ...
    "soutu/js/tu": "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/soutu/js/tu_d03f361",
    ...
    "@searchfe/user-agent": "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/amd_modules/@searchfe/user-agent_77ed402",
    ...
    "@baidu/web-animations-js": "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/amd_modules/@baidu/web-animations-js_8257915",
    ...
    "@baidu/pmd": "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/amd_modules/@baidu/pmd_0b69bc9",
    ...
    "@baidu/ala-util": "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/amd_modules/@baidu/ala-util_ee7e45f",
    ...
    "@baidu/better-scroll": "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/amd_modules/@baidu/better-scroll_3ccd1d2",
    ...
    "@searchfe/promise": "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/amd_modules/@searchfe/promise_902d1ad",
    ...
    "@baidu/atom-web-runtime": "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/amd_modules/@baidu/atom-web-runtime_30eca1a",
    "@baidu/webb/webb2.min": "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/amd_modules/@baidu/webb/webb2.min_af32c86",
    "@baidu/webb": "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/amd_modules/@baidu/webb_ebc38b9",
    "whatwg-fetch/fetch": "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/amd_modules/whatwg-fetch/fetch_2869802",
    "whatwg-fetch": "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/amd_modules/whatwg-fetch_ea21bf5",
    ...
    "versions-compare": "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/amd_modules/versions-compare_b1c909c",
    ...
    "promise-polyfill": "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/amd_modules/promise-polyfill_8c7d679",
    ...
    "@searchfe/assert": "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/amd_modules/@searchfe/assert_66e379a"
}), bds.amd.addPaths({
    "@baidu/ala-util": "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/bundles/ala-util_3965416",
    "@baidu/webb": "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/amd_modules/@baidu/webb/webb2.min_af32c86",
...
jQuery && jQuery.extend({
    stringify: function (t) {
        ...
        if (jQuery._isValidKey(t)) {
            var n = new RegExp("(^| )" + t + "=([^;]*)(;|$)"), i = n.exec(document.cookie);
        ...
        if ("" === t) return "";
        t += "";
        var n = t.split(""), i = n.length, o = 0, s = e || 255;
    ...
    var t = G("container"), e = G("wrapper"), n = function (t, e) {
    ...
    var o = function () {
        ...
        if (t.initIndex ? i = A.groupData[t.initIndex - 1] : (i = {
            ...
            data: {},
            handlers: []
        }, t.initIndex = A.groupData.length + 1, A.groupData.push(i)), "function" == typeof e) i.handlers.push(e); else if ("object" == typeof e) for (var o in e) e.hasOwnProperty(o) && (i.data[o] = e[o]); else i.data[e] = n
    };
    ...
    var t = window.bds.aladdin, e = [], n = {}, i = 0, o = function (t, e) {
        try {
            t.call(e)
        } catch (n) {
        }
    ...
    t.addDisposeHandler = function (t) {
        ...
        _init: function () {
            var t = this, e = t.container, n = c(t.container.getAttribute("data-click"));
            ...
            var o = t.AJAX, c = +new Date, d = i.params || {}, l = {query: e, co: i.co || "", resource_id: n, t: c};
            ...
            var e = $.param(l), u = o.API_URL + "?" + e, m = function () {
                ...
                var e = (new Date).getTime() - p, i = {fm: "opendataajax", srcid: n, time: e, status: t};
                ns_c(i)
            }, h = function (t) {
    ...
    function i(t, e) {
        ...
        a[t] = 1;
        var n = r[t] = [e], i = c.createElement("script");
    ...
    $(document).ready(function () {
        ...
        var e = "opui-style-tag-id", n = "data-for", i = "A.ui", o = document.getElementById(e);
        ...
        var t = /MSIE\s?6/.test(window.navigator.userAgent), e = function (t, e, n) {
            $(t).each(function (t, i) {
                var o = $(i), s = new Image, a = o.attr("src");
                s.onload = function () {
                    var t = e, i = n, a = this.width, r = this.height, c = a / r / (t / i);
        ...
        t && e("img.result-left-img", 98, 121), $(".c-feedback").bind("click", function () {
            ...
            o.use("ALD_feedback", function () {
                ...
                var a = {query: bds.comm.query, srcid: e, target: n, username: bds.comm.username, flag: i},
    ...
    function t(t, e) {
        if ("function" == typeof e || e instanceof Function) {
            var n = o(t);
            s[n.name] = s[n.name] || [], s[n.name].push({prod: n.prod, callback: e})
        }
    }
    ...
    function n(t, e) {
        for (var n = o(t), a = s[n.name] || [], r = {data: e, eventId: t}, c = 0, d = a.length; d > c; c++) {
            var l = a[c];
            try {
    ...
    function t(t, e) {
        var n = "/s?", i = {tn: bds.comm.tn}, o = "wd=" + encodeURIComponent(t);
        e && (i = $.extend(i, e));
    ...
    function bindP5() {
        var item, index = (bds.comm.pageNum - 1) * bds.comm.pageSize + 1,
            ...
            topItems = contentTop && contentTop.children || [], isResult = function (t) {
                ...
                for (var e = 0, n = t.length; n > e; e++) if (item = t[e], isResult(item)) setClickData(item, {p5: index++}); else if (isFrame(item)) try {
    ...
    function bindLogEvent() {
        $body = $("body"), $body.on("mousedown", function (t) {
            var t = window.event || t, e = t.srcElement || t.target, n = $(e);
            try {
    ...
    function getType(t, e, n) {
        ...
        for (var i = e, o = Object.getOwnPropertyNames(LOG_CLASS).map(function (t) {
            ...
            for (d = 0; s > d; d++) if ($(i).hasClass("OP_LOG_" + o[d])) return o[d].toLowerCase();
            for (d = 0; r > d; d++) if ($(i).hasClass("c-" + a[d])) return a[d];
            i = i.parentNode
        }
    ...
    function log(t, e, n, i) {
        if (null == e.getAttribute("data-nolog")) {
            ...
            var s = "http://nourl.ubs.baidu.com", a = n.getAttribute("mu") || s;
            if (a == s) {
            ...
            var d, l = t.length, u = e, m = n.getAttribute("srcid"), p = "",
            ...
            if ("title" == o ? "mu" in b && delete b.mu : b.mu || (b.mu = a), _) "fm" in b && delete b.fm; else if ("input" == o && (b.fm = "beha", b.url = s), b.fm || (b.fm = i), !b.fm) return;
            window.c(b)
        }
    }
...
$(document).ready(function () {
    ...
    $(document).on("click", ".t>a,.op-se-listen-recommend", function (e) {
        e = window.event || e;
        var n = $("#wrapper_wrapper"), i = $(this).closest(".c-container"),
            o = i.length ? i.find(".c-recommend").eq(0) : [], s = i.length ? i.find(".wnor-fanli-wrap") : [];
    ...
    var t = $("#container"), e = $("#wrapper"), n = bds.util.getWinWidth(), i = bds.comm.containerSize;
    if (1217 > n) t.removeClass("container_l container_xl").addClass("container_s"), e.removeClass("wrapper_l").addClass("wrapper_s"), bds.comm.containerSize = "s"; else {
        if (!(n >= 1217)) return;
...
bds.se = bds.se || {}, bds.se.tip = bds.se.tip || {}, bds.comm.tipZIndex = 220, bds.comm.tips = [], bds.se.tip = function (t) {
    this.init = function () {
        ...
        var t, e = {w: this.dom.outerWidth(), h: this.dom.outerHeight()}, n = $(this.getTarget()), i = n.offset(),
            o = {w: n.outerWidth(), h: n.outerHeight()}, s = $(window), a = s.scrollTop(),
            r = {w: s.width(), h: s.height()}, c = {left: 0, top: 0}, d = {};
...
!function () {
    ...
    var e = "//www.baidu.com/", n = -1 != navigator.userAgent.indexOf("MSIE") && !window.opera,
        i = (100 * Math.random(), "百度一下，你就知道"), o = "";
    ...
    return {setUserInfo: i, open: o, success: s, setSubpro: a, setMakeText: r}
}(), window._invoke_login = function (t, e) {
    bds.se.login.open(t, e)
}, !function () {
    function t() {
        var t, e = "http://isphijack.baidu.com/index.php?cb=isp_hijack", n = [];
...
bds.se = bds.se || {}, bds.se.tool = bds.se.tool || {}, bds.comm.host = {
    ...
    this.init = function () {
        ...
        var officalLogo = $($(item).closest(".c-container").find("h3.t").children()[1]),
            vLogo = $(item).parent().find(".vstar"), isOffical = 0, vLevel = 0;
    ...
    this.op = t || {}, this.init = function (t, e) {
        $.getScript(bds.comm.host.share, function () {
            ...
            __bdshare.render({boxEle: i, url: t.url, txt: t.title + " -- 分享自百度搜索"})
        })
    }(this.op, e)
}, bds.se.tool.favo = function (t, e) {
    if (this.op = t || {}, this.init = function (t, e) {
        if (t) {
            var n = document.createElement("script"), i = bds.comm.host.bfe, o = bds.comm.host.favo;
...
bds.se = bds.se || {}, bds.se.slide = function (t) {
    var e, n, i, o, s, a = this, r = {}, d = [], l = 0, u = null;
    this._default = {
        target: $("#lg"),
        src: "",
        width: 270,
        ...
        var t = a.op.target.find("map"), e = t.length ? t.find("area").eq(0) : "", i = a.op.play;
        ...
        var t = '<div style="position:absolute;top:0;left:50%;background:url(#{0}) no-repeat #{1};cursor:#{2};width:#{3}px;height:#{4}px;margin-left:-#{5}px;display:none;"></div>',
            ...
            p = m ? "pointer" : p, f = a.op.animations instanceof Array ? a.op.animations : [a.op.animations],
            h = a.op.width, b = a.op.height;
        ...
        if (!(l >= d.length)) {
            var n = d[l], o = n.isAutoPlay, s = n.trigger_type, r = n.trigger_fn, c = n.trigger_duration,
                m = n.trigger_frame, p = $("#lg area");
        ...
        var t, n = d[l], s = n.duration, r = n.frame_start, c = n.frame_end, u = n.delay, m = n.repeats,
            p = n.process_after, f = n.trigger_type, h = r - 1 > 0 ? r - 1 : 0, b = n.event_loop || 0, g = 0;
...
bds.se = bds.se || {}, bds.se.banner = function (t, e, n) {
    this.init = function () {
        ...
        var t = $("#head"), e = $(window), n = $(".res_top_banner");
        t.css("position"), $(window).scroll(function () {
            var i = n.height() || 0, o = e.scrollTop();
    ...
    $(window).on("swap_end", function () {
        ...
        if (winFilter = /NT 6.1|NT 6.2|NT 6.3/i.test(navigator.userAgent), bds.comm.topHijack) for (var i = 0; i < bds.comm.topHijack.length; i++) if ("hint_topHijack" == bds.comm.topHijack[i].templateName) {
    ...
    function t() {
        ...
        }), t > 0 && ns_c({tab: "safetip", num_unsafe: t, prd: e.join("|"), hintId: i, hintTpl: n})
    }
...
bds.se = bds.se || {}, bds.se.trust = bds.se.trust || {}, bds.se.trust = function () {
    function t() {
        d = [], l = [], $(".c-trust").each(function () {
            var t = $(this), e = this.getAttribute("data_key");
            ...
            p = $.parseJSON($(this).attr("hint-data")), p && !$(this).attr("render") && (m = $(this), a(p, $(this).attr("hint-type")), $(this).attr("render", "render"))
        }), d.length < 1 || (f && b < d.length && (f = !1, h && h.abort()), e(), b = d.length)
    }
    ...
    function n(t) {
        f = !1, 0 == t.code && $(l).each(function () {
            ...
            p = t.data[e], p && (m = $(this), m.html(""), p.vstar && p.vstar.hint && p.vstar.hint.length > 0 && i(p.vstar.hint[0].vlevel, p.vstar.url), p.medical && o(), p.aviation && s())
        })
    }

    function i(t, e) {
        var n = $("<span>", {"class": "c-vline"}),
            i = $("<a>", {"class": "c-icon c-icon-v" + t, target: "_blank", onclick: "return false", href: "#"});
        e && i.attr({href: e, onclick: ""}), m.append(n), m.append(i), a(p.vstar, "vstar")
    }

    function o() {
        var t = $("<span>", {"class": "c-vline"}),
            e = $("<a>", {"class": "c-icon c-icon-med", target: "_blank", onclick: "return false", href: "#"});
        m.append(t), m.append(e), a(p.medical, "medical")
    }

    function s() {
        var t = $("<span>", {"class": "c-vline"}),
            e = $("<a>", {"class": "c-icon c-icon-air", target: "_blank", onclick: "return false", href: "#"});
        m.append(t), m.append(e), a(p.aviation, "aviation")
    }

    function a(t, e) {
        var n = t.hint, i = "over", o = t.url, s = t.webIMUrl;
        if (t && n) {
            if ("vstar" == e || "baozhang" == e || "baozhang-v" == e || "chengqi" == e || "baozhang-v-auth" == e) var a = "<div class='c-tip-cer hitcon'><ul>"; else var a = "<div class='c-tip-info hitcon'><ul>";
            for (var c = 0; c < n.length; c++) "" != n[c] ? (a += "<li ", a += n[c].icon ? "class='c-tip-item-i'><img src='" + n[c].icon + "' class='c-customicon c-gap-icon-right-small c-tip-item-icon' />" : ">", a += r(n[c].txt), a += "</li>") : i = "none";
            a += "</ul></div>";
            var d = !1, l = !1;
            ...
            var u = new bds.se.tip({
                ...
                align: "auto",
                content: a,
                arrow: {has: 1, offset: 35, r: d, c: l},
                offset: {x: 0, y: 25}
            });
            u.onShow = function () {
                A.use("honourCard4", function () {
                });
                var i = n[0].vlevel, r = n[0].unfixedInfo;
                ns_c({
    ...
    var c = 4, d = [], l = [];
    if (bds.util && bds.util.domain && bds.util.domain.get) var u = bds.util.domain.get("http://tag.baidu.com"); else var u = "http://tag.baidu.com";
    var m = null, p = null, f = !1, h = null, b = 0;
    return t(), {init: t, render: n}
}();
...
$(function () {
    ...
    var t = '<div id="_FP_userDataDiv" style="behavior:url(#default#userdata);width:0px;height:0px;position:absolute;top:-1000px;left:-1000px"></div><div id="_FP_comDiv" style="behavior:url(#default#clientCaps);width:0px;height:0px;position:absolute;top:-1000px;left:-1000px"></div>',
        e = "//www.baidu.com/cache/fpid/ielib_0108.js", n = "//www.baidu.com/cache/fpid/chromelib_0108.js",
        i = document.title,
    ...
    if (l && (c = !0, r = l[1]), !(c && r >= 39)) {
        ...
        var u = function (t) {
            ...
            var e = bds.comm.qid, n = "_WWW_BR_API_" + (new Date).getTime(), o = window[n] = new Image;
            o.onload = function () {
                window[n] = null
            };
...
bds.se = bds.se || {}, bds.se.upn = {
    regexp: /BD_UPN=([\w|\d]*)/, cookieset: [], write: function (t) {
        ...
        var t = this;
        try {
            for (var e = "", n = 0; n < t.cookieset.length; n++) if (t.cookieset[n] && t.cookieset[n].k && t.cookieset[n].v) {
                var i = t.cookieset[n].k + "", o = t.cookieset[n].v + "";
    ...
    var n = navigator.userAgent, i = n.toLowerCase();
    ...
    check: function () {
        ...
        var t = $(".ec_bdtg"), e = $("#ec_im_container").children("div"), n = e.length, i = n - 1;
        for (bds.se.heightControl.check() && t && t.length && t.css("display", "none"); bds.se.heightControl.check() && i >= 0;) {
            var o = e[i];
            $(o).css("display", "none"), i--
        }
    }, cleanRes: function () {
        var t = $("#content_right").find(".result-op"), e = t.length, n = e - 1;
        if (0 == n) {
            var i = $(t[0]).parent();
            $("#content_right").height() + t.height() < $("#content_left").height() && i.css({position: "static"})
        } else {
    ...
    t.prototype = {
        setCommLog: function (t, e, n) {
            ...
            var e = 0 === t ? this.stayTime : (new Date).getTime() - this.start, n = bds && bds.comm && bds.comm.qid;
            if (n && n in this.commLog && n in this.sendNum) {
                var i = [{stay_time: e, send_num: this.sendNum[n]}];
                this.send({type: t, fm: "new_heart", data: i}, this.keyMap.new_heart)
            }
        }, startHeart: function () {
            var t = this, e = t.fb();
            ...
            function n(t, e) {
                var n = [];
                if ("mouse" === t) n[0] = e.pageX, n[1] = e.pageY; else if ("scroll" === t) {
                    var i = $(window);
            ...
            var i = t + "Time", o = this[t + "Speed"], s = this;
            if (0 === s[t].length) {
                var a = n(t, e);
            ...
            var i = {startTime: this.start, record: []}, o = e, s = n;
            ...
            for (var a in t) if (!(t[a][0] < o) && (t[a][0] < s && i.record.push(t[a]), t[a][0] >= s)) break;
            return i
        }, send: function (t, e, n) {
            if (!t) return !1;
            ...
            t in o || (o[t] = [[], []]), n && n.level === !0 ? o[t][0].push(encodeURIComponent($.stringify(e))) : o[t][1].push(encodeURIComponent($.stringify(e)))
            ...
            function n() {
                ...
                i.length > 0 && a.push({qid: l, key: u, type: t, data: "%5B" + i.join("%2C") + "%5D", host: r})
            }

            var i, o, s = this.dataStore, a = [], r = 0, c = !1,
            ...
            var n, i, o = this, s = e === !0 ? 0 : 100, a = setInterval(function () {
            ...
            null === t.cycle && (t.cycle = 1), t.t = setTimeout(function () {
                var e = t.fetchData(0), n = e.length;
                -1 === t.storeLen && (t.storeLen = n), 0 !== t.storeLen && n / t.storeLen >= 2 && t.curSpeed > t.MIN_SPEED && (t.curSpeed -= 1e3), (0 === n || t.storeLen / n >= 2) && t.curSpeed < t.MAX_SPEED && (t.curSpeed += 1e3), t.startSend(e, 0), t.startCycle()
            }, t.curSpeed)
    ...
    bds.comm.encTn && $.setCookie("H_PS_645EC", bds.comm.encTn, {expires: 2592e3}), bds.se.trust && bds.se.trust.init(), bds.se.heightControl.init(), bds.util.setContainerWidth(), $(".content_none").length > 0 && new bds.util.setFootStyle, bds.comm.feedback = 1, bds.comm.feedback ? t() ? $(document).delegate(".feedback", "click", function () {
        ...
        $.getScript("https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/plugins/feedback_67607cd.js", function () {
            var e = t.getAttribute("data-feedbackid") || 1, n = {product_id: 18, entrance_id: e},
                i = {username: bds.comm.username, query: bds.comm.query, fb_qid: bds.comm.qid};
    ...
    $(window).one("swap_end", function () {
        $("body").on("mousedown", ".se_common_hint a", function () {
            var t = $(this), e = t.parents(".se_common_hint"), n = e.attr("data-id") || "",
                i = e.attr("data-tpl") || "", o = e.find("a").index(t);
            ns_c_pj({hintId: n, hintTpl: i, title: t.html(), pos: o, qid: bds.comm.qid || ""}, "pj=hint&")
        })
    })
}(), $(function () {
    ...
    dataType: "script",
    cache: !0,
    url: "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/home/js/nu_instant_search_b73e920.js"
...
bds.se = bds.se || {}, bds.se.speedTester = function () {
    ...
    t.se = t.se || {}, t.se.QuickDelete = function (t, e) {
        ...
        constructor: t.se.QuickDelete, _init: function () {
            ...
            var t = this.form, e = this.options, n = e.top || 0, i = e.right || 0,
                o = $.trim(t.val()) ? "block" : "none", s = "quickdelete", a = t.parent(),
            ...
            var e = this.form, n = this.options.elem, i = this;
            e.on("focus", function () {
    ...
    if (window.ctwin && window.ctwin.sendRequest("//www.baidu.com/?tn=baidu", {content_syni: 1}), window.performance && performance.timing) {
        var t = function () {
            var t = n("navigation"), e = n("domainLookup"), i = n("connect"), o = n("secureConnection"),
                s = (n("redirect"), n("request")), a = n("response"),
                r = {start: performance.timing.domLoading, end: performance.timing.domComplete}, c = n("loadEvent");
            return {
        ...
        }, e = Cookie.get("__bsi"), n = function (t) {
            var e = performance.timing, n = e[t + "Start"] ? e[t + "Start"] : 0, i = e[t + "End"] ? e[t + "End"] : 0;
            return {start: n, end: i, value: i - n > 0 ? i - n : 0}
        }, i = function () {
            var n = [], i = t();
...
$(document).delegate(".head_nums_cont_outer", "mousedown", function () {
    if ("undefined" != typeof bds.comm.search_tool) {
        ...
        var t = $(this), e = t.find(".search_tool").eq(0), n = t.find(".search_tool_close").eq(0),
            i = t.find(".head_nums_cont_inner").eq(0);
        e.on("click", function () {
            i.animate({top: 0}, 250), ns_c({fm: "advTool", qid: bds.comm.qid, title: encodeURI("搜索工具"), rsv_advTool: 0})
        }), n.on("click", function () {
            i.animate({top: -42}, 250, function () {
            ...
            r += bds.comm.search_tool.st || bds.comm.search_tool.et ? " <li><a href='javascript:;' onClick='advChangeUrl(\"gpc\",\"stf\",this.innerHTML,0)'>时间不限</a></li>" : " <li><span>时间不限</span></li>", r += bds.comm.search_tool.st >= bds.comm.search_tool.thisDay && "1" == bds.comm.search_tool.stftype ? " <li><span>一天内</span></li>" : " <li><a href='javascript:;' onClick='advChangeUrl(\"gpc\",\"stf=" + bds.comm.search_tool.oneDay + "," + bds.comm.serverTime + "|stftype=1\",this.innerHTML,1)'>一天内</a></li>", r += bds.comm.search_tool.st >= bds.comm.search_tool.thisWeek && bds.comm.search_tool.st < bds.comm.search_tool.thisDay && "1" == bds.comm.search_tool.stftype ? " <li><span>一周内</span></li>" : " <li><a href='javascript:;' onClick='advChangeUrl(\"gpc\",\"stf=" + bds.comm.search_tool.oneWeek + "," + bds.comm.serverTime + "|stftype=1\",this.innerHTML,2)'>一周内</a></li>", r += bds.comm.search_tool.st >= bds.comm.search_tool.thisMonth && bds.comm.search_tool.st < bds.comm.search_tool.thisWeek && "1" == bds.comm.search_tool.stftype ? " <li><span>一月内</span></li>" : " <li><a href='javascript:;' onClick='advChangeUrl(\"gpc\",\"stf=" + bds.comm.search_tool.oneMonth + "," + bds.comm.serverTime + "|stftype=1\",this.innerHTML,3)'>一月内</a></li>", r += bds.comm.search_tool.st >= bds.comm.search_tool.thisYear && bds.comm.search_tool.st < bds.comm.search_tool.thisMonth && "1" == bds.comm.search_tool.stftype ? " <li><span>一年内</span></li>" : " <li><a href='javascript:;' onClick='advChangeUrl(\"gpc\",\"stf=" + bds.comm.search_tool.oneYear + "," + bds.comm.serverTime + "|stftype=1\",this.innerHTML,4)'>一年内</a></li>", r += " <li class='c-tip-custom'>", r += " <hr />自定义", r += " <p class='c-tip-custom-st'>从<input name='st' date-min='0' date-max='" + formatDate(1e3 * bds.comm.serverTime) + "' type='txt' autocomplete='off' ", r += bds.comm.search_tool.st && bds.comm.search_tool.et && "2" == bds.comm.search_tool.stftype ? "value='" + formatDate(1e3 * bds.comm.search_tool.st, "-") + "' data-value='" + 1e3 * bds.comm.search_tool.st + "' class='c-tip-custom-input'/></p>" : "value='" + formatDate(1e3 * bds.comm.serverTime, "-") + "' data-value='' class='c-tip-custom-input c-tip-custom-input-init'/></p>", r += "  <p class='c-tip-custom-et'>至<input name='et' date-min='0' date-max='" + formatDate(1e3 * bds.comm.serverTime) + "' type='txt' autocomplete='off' ", r += bds.comm.search_tool.st && bds.comm.search_tool.et && "2" == bds.comm.search_tool.stftype ? "value='" + formatDate(1e3 * bds.comm.search_tool.et, "-") + "' data-value='" + 1e3 * bds.comm.search_tool.et + "' class='c-tip-custom-input'/></p>" : "value='" + formatDate(1e3 * bds.comm.serverTime, "-") + "' data-value='' class='c-tip-custom-input c-tip-custom-input-init'/></p>", r += "<div class='c-tip-timerfilter-custom-error'>自定义时间错误！</div>", r += "<a href='javascript:;' class='c-tip-custom-submit'>确认</a>", r += "</li></ul></div>", timefilterTip = new bds.se.tip({
                ...
                onShow: function () {
                    $(this.getTarget()).width() > 95 && $("ul", this.getDom()).width($(this.getTarget()).width() + 20), $(".c-tip-custom-input").on("click", function (t) {
                        var e = this, n = null, i = new Date, o = $(e).parents(".c-tip-custom"),
                            s = o.find("input[name='st']"), a = o.find("input[name='et']");
                    ...
                    try {
                        $(".c-tip-custom-submit").off("click.searchTool").on("click.searchTool", function (t) {
                            var e = this, n = $(e).parents(".c-tip-custom"),
            ...
            onShow: function () {
                ...
                try {
                    $(".c-tip-timerfilter-si-submit").off("click.searchTool").on("click.searchTool", function (t) {
                        var e = this, n = $(e).parents(".c-tip-timerfilter-si"), i = $("input", n).val(),
                            o = queryReplace("site");
                        if ("" == i) ns_c({
                            fm: "advTool",
                            qid: bds.comm.qid,
    ...
    function t() {
        function t(t, e) {
            var n = {top: e.offset().top, left: e.offset().left}, i = {width: e.width(), height: e.height()},
                o = function () {
            ...
            return {id: s, pos: n, size: i, dataClick: o, dom: e}
        }
    ...
    bds.se.display = function () {
        ...
        init: function () {
            ...
            for (var i in t.expand) if (i && t.expand[i]) for (var o in t.expand[i]) if (o && t.expand[i][o] && t.expand[i][o].length) for (var s = t.expand[i][o], a = 0; a < s.length; a++) {
                var r = {};
                r[i] = {expand: {}}, r[i].expand[o] = {}, r[i].expand[o][a] = s[a], bds.log.send.sendPack("new_disp", r)
            }
        }, getBase: function () {
            var t = this, e = {};
            ...
            for (var e = this, n = t, i = 0, o = Math.min(n.length, 10); o > i; i++) {
                var s = n[i].id, a = e.getResultDisplay(n[i]);
    ...
    t.prototype = {
        init: function () {
            ...
            var e = this;
            $.each(t, function (t, n) {
                var i = 200, o = !1, s = null;
                n.dom.bind("mouseenter.useraction", function () {
                    null !== s && clearTimeout(s), s = setTimeout(function () {
                        e.sendLog("new_view", {type: "mouseIn", id: n.id, t: (new Date).getTime()}), o = !0, s = null
                    }, i)
                ...
                if (1 !== n.visible || i) {
                    if (0 === n.visible && i) {
                        if (t.sendLog("new_view", {
                            ...
                            var o = (parseInt(n.id.substr(1)) - 1) % bds.comm.pageSize, s = bds.comm.orderplay[o];
            ...
            var i = t + "Time", o = t + "Change", s = this;
            null === s[i] && e()
        }, collect: function () {
            this.init();
            var t = this;
    ...
    moveArrow: function (t) {
        var e = this, n = {opacity: e.op.endOpacity};
    ...
    log: function (t) {
        var e = {}, n = this.op.target.attr("data-click"), i = this.op.target.attr("srcid"),
            o = this.op.target.attr("tpl"), s = this.op.target.attr("mu");
        if (i && (e.rsv_srcid = i), o && (e.rsv_tpl = o), s && (e.mu = s), n && $.extend(e, $.parseJSON(n)), e.p1 && !e.p5 && (e.p5 = e.p1), e.p5 && !e.p1 && (e.p1 = e.p5), !e.p1 && !e.p5) for (var a = $("#content_left").get(0), r = a.children, d = 1, l = 0, u = r.length; u > l; l++) if (1 == r[l].nodeType && r[l].className && /\bresult(\-op)?\b/.test(r[l].className)) {
    ...
    getJsonp: function (t) {
        var e = this.op.target.find(".t>a").eq(0), n = (e.length ? e.attr("href") : this.op.target.attr("mu")) || "",
            i = n && n.match(/.*url=([^&]*).*/), o = bds.comm.query;
        if (i && i.length && i.length > 0 && i[1]) {
            n = i[1];
            var s = "http://lcr.open.baidu.com/link?url=" + encodeURIComponent(n) + "&query=" + encodeURIComponent(o),
    ...
    getRemoteData: function (t) {
        var e = this, n = "recommend_common_merger_online";
    ...
    asynClkRcmd: function (t) {
        var e = this, t = t[0] || {}, n = $("#wrapper_wrapper");
        if (t && t.linkInfo) {
            var i = e.op.target.find(".c-recommend"), o = i.find("a"), s = t.tip || "为您推荐：";
            if (t.defaultHide, o && o.length && (o.remove(), i.append(e.buildRcmdDom(t))), !i || !i.length) {
                ...
                n.find(".c-recommend").hide(), a.append(e.buildRcmdDom(t)), e.op.target.append(a)
            }
        }
    },
    buildRcmdDom: function (t) {
        for (var e = this, n = "", i = t.linkInfo, o = t.linkInfo2, s = encodeURIComponent(bds.comm.query), a = 0, r = i.length; r > a; a++) {
            var c = i[a].txt, d = i[a].wd, l = i[a].sa, u = "c-gap-left-large";
            0 == a && (u = "");
            var m = "wd=" + d + "&rsv_crq=" + l + "&bs=" + s, p = e.buildURL(m);
            n += '<a class="' + u + '" href="' + p + '" title="' + escapeHTML(c) + '" target=_blank>' + escapeHTML(c) + "</a>"
        }
        if (o) {
            ...
            for (var a = 0, r = o.length; r > a; a++) {
                ...
                var m = "wd=" + d + "&rsv_crq=" + l + "&bs=" + s, p = e.buildURL(m);
                n += '<a class="' + u + '" href="' + p + '" title="' + escapeHTML(c) + '" target=_blank style="' + f + '">' + escapeHTML(c) + "</a>"
            }
        }
        return n
    },
    buildURL: function (t) {
        var e = "/s?", n = {tn: bds.comm.tn}, i = $("#form"), o = i.find("input[name=rsv_idx]"), s = "";
    ...
    createRecommDom: function () {
        ...
        var i = $("#foot");
        "static" === i.css("position") && i.css({position: "relative", "z-index": 104})
    },
    setRecommSize: function () {
        var t = $("#content_right"), e = $("#wrapper_wrapper"), n = $("body"), i = $(window), o = t.offset(),
            s = {w: n.width()}, a = {h: i.height()}, r = i.scrollTop();
    ...
    setRecommTop: function () {
        ...
        }).find(".rrecom-container").css({"margin-top": "0px"}), bds.se.recommend.prototype.global.originalTop = t < e.top - n ? e.top - n : t
    },
    ...
    bindRecommEvent: function () {
        ...
        this.recommDom.find(".rrecom-btn-close").eq(0).on("click", function () {
            ...
            var e, n, i, o = {top: t.global.topDom.offset().top - t.global.topGap},
            ...
            if (t.recommDom && "none" !== t.recommDom.css("display")) {
                ...
                t.global.originalTop < e ? (maxMargin = Math.min(t.recommDom.height() - r.height() - 82 - 75, 0), r.css({"margin-top": Math.max(t.global.originalTop - e, maxMargin)})) : r.css({"margin-top": "0px"}), n && (i = $("#content_right").offset().left, "fixed" === t.recommDom.css("position") ? t.recommDom.css("left", parseInt(i) - n) : t.recommDom.css("left", parseInt(i)))
            }
    ...
    showRecommDom: function () {
        ...
        if (t.currInstance !== t, "none" === t.recommDom.css("display")) {
            ...
            var e = t.recommDom.find(".rrecom-container"), n = bds.comm.recommends.recommWidth;
            e.css({width: 0}).animate({width: n + "px"}, 200)
        }
    ...
    var e = t.dom || "", n = t.id || "", i = t.tnp || "", o = t.wd || "",
    ...
    function n() {
        var t = Math.round(1e3 * Math.random()) % u.length, e = new Image, n = new Image, i = u[t];
        e.onload = function () {
    ...
    var t, e,
        n = bds && bds.util && bds.util.domain && bds.util.domain.get("http://sensearch.baidu.com/sensearch/selecttext");
    $(window).one("swap_end", function () {
            ...
            if (!t || !$(i.target).closest(t.getDom()).length) try {
                setTimeout(function () {
                    ...
                    if (r && r.length > 1 && c.closest("#content_left .result .c-abstract,#content_left .result .t").length) {
                        ...
                        if (!i.test(r)) return;
                        e = $.ajax({
                            url: n, dataType: "jsonp", jsonp: "cb", timeout: 5e3, data: {q: r}, success: function (e) {
                                var n = "";
                                if (e && e.data && e.data.type && e.data.to && "zh" == e.data.to && e.data.result && e.data.result.length && e.data.result != r) if (1 == e.data.type) for (var i = e.data.result, o = 0, s = Math.min(i.length, 2); s > o; o++) n += (0 == o ? "" : "<br/>") + (i[o].pre ? i[o].pre + "&nbsp;" : ""), n += i[o].cont ? $.subByte(i[o].cont, 46 * (1 == s ? 2 : 1) + 1) : "";
        ...
        this.init = function () {
            ...
            if ("sug" === o) {
                ...
                var i = e,
                    ...
                    key: "27465",
                    value: "变形、错乱、乱码等问题"
                }, {key: "27469", value: "页面结果与搜索词无关"}, {key: "27467", value: "其他问题及建议"}], i = a(r),
            ...
            var e = $(this.dom).find(".fb-checkbox.fb-checkbox-selected");
            sugText = [], e.each(function (t, e) {
                sugText.push($(e).find("div").text())
            }), this.sugText = sugText.join("&");
            var n = 26138, s = t.type;
            ("27642" == this.type || "27643" == this.type || "33081" == this.type) && (n = this.type, s = 0), data = "sug" === o ? {
                product_type: "27642",
                sug_text: t.sugText,
    ...
    function c(t, e) {
        this.init = function () {
            ...
            if (this.query = decodeURIComponent(bds.comm.query), this.srcid = t && t.attr("srcid") || "-1", this.tpl = t && t.attr("tpl") || "", this.cururl = t && t.find("a").eq(0).attr("href") || "", this.url = window.location.href || "", this.time = e.getFullYear() + "/" + (e.getMonth() + 1) + "/" + e.getDate() + " " + e.getHours() + ":" + e.getMinutes() + ":" + e.getSeconds(), this.username = bds.comm.username || "", t) if (t.closest("#con-ar").length) {
                this.order = "con-ar";
                var n = [{key: "27642", value: "申请删除提示词"}, {key: "33081", value: "侵犯个人隐私与权益"}, {
                    key: "27464",
                    value: "内容或图片陈旧"
                ...
                var n = [{key: "27464", value: "内容或图片陈旧"}, {key: "33081", value: "侵犯个人隐私与权益"}, {
                    key: "27465",
                    value: "变形、错乱、乱码等问题"
                ...
                this.order = t.attr("id") || "-1";
                var n = [{key: "27643", value: "申请删除或更新这条信息"}, {key: "33081", value: "侵犯个人隐私与权益"}, {
                    key: "27464",
                    value: "内容或图片陈旧"
                }, {key: "27465", value: "变形、错乱、乱码等问题"}, {key: "27466", value: "这条结果与搜索词无关"}, {
                    key: "27467",
                    value: "其他问题及建议"
                }];
                this.content_tips_div = a(n)
                ...
                this.order = "ec";
                var n = [{key: "27470", value: "推广信息侵权"}, {key: "33081", value: "侵犯个人隐私与权益"}, {
                    key: "27471",
                    value: "推广信息质量差"
            ...
            $(this.dom).find(".fb-close").on("click", function () {
                ...
                }, 50)) : -1 != [33081].indexOf(Number($(t.dom).find(".fb-select-value").val())) && 0 == $(t.dom).find(".fb-photo-block").attr("upload_num") ? ($(t.dom).find(".fb-hint-error-photo").css("display", "block"), setTimeout(function () {
                    $(t.dom).find(".fb-hint-error-photo").css("opacity", "1"), setTimeout(function () {
                        $(t.dom).find(".fb-hint-error-photo").removeAttr("style")
                    }, 1500)
                }, 50)) : t.post() : ($(t.dom).find(".fb-hint-no-email").css("display", "block"), setTimeout(function () {
                    $(t.dom).find(".fb-hint-no-email").css("opacity", "1"), setTimeout(function () {
                        $(t.dom).find(".fb-hint-no-email").removeAttr("style")
                ...
                o.click(), $(o).on("change", function (t) {
                    ...
                    if (s && ("image/png" == s || "image/jpg" == s || "image/jpeg" == s || "image/jpeg" == s) && $(t.currentTarget).val() && i.size < 2097152) {
                        ...
                        a.addEventListener("load", function () {
                            ...
                            var t = e.find(".fb-photo-block"), i = t.attr("upload_num");
                ...
                var o = n.find(".fb-photo-block"), s = o.attr("upload_num");
            ...
            var t = this;
            this.content = $(this.dom).find(".fb-des-content").val(), this.type = $(this.dom).find(".fb-select-value").val(), this.email = $(this.dom).find(".fb-email").val();
            var n = $(this.dom).find(".fb-photo-block").find(".fb-photo-update-item-show-img");
            bds.se.ShortCut.get_Snapshot_list(-bds.se.ShortCut.curListDom.offset().left, -bds.se.ShortCut.curListDom.offset().top, bds.se.ShortCut.curListDom.width() + 20, bds.se.ShortCut.curListDom.height() + 12, function () {
                var i = 26138, o = t.type;
                ("27642" == t.type || "27643" == t.type || "33081" == t.type) && (i = t.type, o = 0), data = {
                    product_type: i,
                    content: t.content,
                    type: o,
                    ...
                    platform: "pc",
                    cururl: t.cururl,
                    img_base64_1: n.eq(0).attr("src"),
                    img_base64_2: n.eq(1).attr("src"),
                    img_base64_3: n.eq(2).attr("src"),
                    img_base64_4: n.eq(3).attr("src")
    ...
    bds && bds.se && (bds.se.ShortCut = {
        ...
        initSugBar: function (t) {
            $(window).scrollTop(0), $(".fb-mask").length > 0 && i(), bds.se.ShortCut.rdialog = new r("", "", t, "sug"), $("#container").append("<div class='fb-mask'></div>"), $(".fb-mask").width($("body").width()), $(".fb-mask").height($("#wrapper_wrapper").height()), $(".fb-mask").on("click", function () {
        ...
        init_shade: function () {
            $("#container").append("<div class='fb-mask' data-html2canvas-ignore='true'></div>"), $(".fb-mask").width($("body").width()), $(".fb-mask").height($("#wrapper_wrapper").height()), s(), $(".fb-list-container").hover(function (t) {
            ...
            bds.se.ShortCut.rdialog = new r, t.init_shade(), $(".fb-canvas-block").addClass("c-loading"), html2canvas(document.body, {
                proxy: bds.util.domain.get("f3.baidu.com") + "/getProxyImage.php", onrendered: function (e) {
                    ...
                    i.drawImage(e, 0, 0), bds.se.ShortCut.img_base64 = n.toDataURL("image/png"), $(".fb-canvas-block img").attr("src", n.toDataURL("image/png")), setTimeout(function () {
                        ...
                        var e = $(window).scrollTop(), n = $(document).height(), i = $(window).height();
        ...
        html2canvas: function () {
            !function (t, e, n) {
                ...
                function o(t, e, n, i, o, s) {
                    ...
                    if (1 === u.length && (l = u[0], u = [], u[0] = l, u[1] = l), -1 !== u[0].toString().indexOf("%")) c = parseFloat(u[0]) / 100, r = n.width * c, "backgroundSize" !== t && (r -= (s || i).width * c); else if ("backgroundSize" === t) if ("auto" === u[0]) r = i.width; else if (u[0].match(/contain|cover/)) {
                ...
                d.Util = {}, d.Util.trimText = function (t) {
                    ...
                    function s(e, n) {
                        var i, o = t.runtimeStyle && t.runtimeStyle[e], s = t.style;
                    ...
                    try {
                        e = t.nodeName && "IFRAME" === t.nodeName.toUpperCase() ? t.contentDocument || t.contentWindow.document : function (t) {
                            ...
                            return null !== t && !function (t, e) {
                                var i = t.length, o = 0;
                                if ("number" == typeof e.length) for (var s = e.length; s > o; o++) t[i++] = e[o]; else for (; e[o] !== n;) t[i++] = e[o++];
                                return t.length = i, t
                            }(e, t), e
                        }(t.childNodes)
                    } catch (o) {
                    ...
                    return function (e, i, o) {
                        ...
                        var s, a, r, c = o.createElement("div"), d = o.createElement("img"),
                    ...
                    d.Generate.parseGradient = function (e, n) {
                        ...
                        if (s) switch (s[1]) {
                            ...
                            case"-webkit-gradient":
                                if (i = {
                                    ...
                                    y1: 0,
                                    colorStops: []
                                }, r = s[3].match(/(\d{1,3})%?\s(\d{1,3})%?,\s(\d{1,3})%?\s(\d{1,3})%?/), r && (i.x0 = r[1] * n.width / 100, i.y0 = r[2] * n.height / 100, i.x1 = r[3] * n.width / 100, i.y1 = r[4] * n.height / 100), r = s[4].match(/((?:from|to|color-stop)\((?:[0-9\.]+,\s)?(?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\)\))+/g)) for (c = r.length, o = 0; c > o; o += 1) l = r[o].match(/(from|to|color-stop)\(([0-9\.]+)?(?:,\s)?((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\)/), a = parseFloat(l[2]), "from" === l[1] && (a = 0), "to" === l[1] && (a = 1), i.colorStops.push({
                                    color: l[3],
                                    stop: a
                                });
                                break;
                            ...
                            case"-o-radial-gradient":
                                ...
                                if (r = s[5].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\)(?:\s\d{1,3}(?:%|px))?)+/g)) for (c = r.length, d = 1 / Math.max(c - 1, 1), o = 0; c > o; o += 1) l = r[o].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\s*(\d{1,3})?(%|px)?/), l[2] ? (a = parseFloat(l[2]), a /= "%" === l[3] ? 100 : n.width) : a = o * d, i.colorStops.push({
                                    color: l[1],
                                    stop: a
                                })
                        }
                        ...
                        if (0 !== n.width && 0 !== n.height) {
                            ...
                            if (c.width = n.width, c.height = n.height, o = d.Generate.parseGradient(t, n)) if ("linear" === o.type) {
                                ...
                                var m = e.createElement("canvas"), p = m.getContext("2d"), f = Math.max(o.rx, o.ry),
                                    h = 2 * f;
                        ...
                        var e, n = ["M", "CM", "D", "CD", "C", "XC", "L", "XL", "X", "IX", "V", "IV", "I"],
                            i = [1e3, 900, 500, 400, 100, 90, 50, 40, 10, 9, 5, 4, 1], o = "", s = n.length;
                        if (0 >= t || t >= 4e3) return t;
                        for (e = 0; s > e; e += 1) for (; t >= i[e];) t -= i[e], o += n[e];
                        return o
                    }
                    ...
                    function v(t, e, n, i) {
                        var o;
                        if (ce.rangeBounds) ("none" !== n || 0 !== d.Util.trimText(e).length) && (o = w(e, t.node, t.textOffset)), t.textOffset += e.length; else if (t.node && "string" == typeof t.node.nodeValue) {
                    ...
                    function _(t) {
                        var e = t.parentNode, n = re.createElement("wrapper"), i = t.cloneNode(!0);
                    ...
                    function y(t, e, n) {
                        var i, o, s = n.ctx, a = ue(t, "color"), c = ue(t, "textDecoration"), l = ue(t, "textAlign"),
                    ...
                    function $(t) {
                        var e = -1, n = 1, i = t.parentNode.childNodes;
                        if (t.parentNode) {
                    ...
                    function T(t, e, n) {
                        var i, o, s, a = e.ctx, r = ue(t, "listStyleType");
                    ...
                    function S(t, e) {
                        var n = Math.max(t.left, e.left), i = Math.max(t.top, e.top),
                            o = Math.min(t.left + t.width, e.left + e.width),
                            s = Math.min(t.top + t.height, e.top + e.height);
                        return {left: n, top: i, width: o - n, height: s - i}
                    }
                    ...
                    function D(t, e, n, i, o) {
                        var s = u(e, "paddingLeft"), a = u(e, "paddingTop"), r = u(e, "paddingRight"),
                            c = u(e, "paddingBottom");
                    ...
                    function A(t, e, n, i) {
                        ...
                        return {
                            start: t, startControl: e, endControl: n, end: i, subdivide: function (s) {
                                var a = o(t, e, s), r = o(e, n, s), c = o(n, i, s), d = o(a, r, s), l = o(r, c, s),
                                    u = o(d, l, s);
                    ...
                    function O(t, e, n) {
                        var i = t.left, o = t.top, s = t.width, a = t.height, r = e[0][0], c = e[0][1], d = e[1][0],
                            l = e[1][1], u = e[2][0], m = e[2][1], p = e[3][0], f = e[3][1], h = s - d, b = a - u,
                            g = s - m, v = a - f;
                        return {
                    ...
                    function M(t, e, n) {
                        var i, o, s, a, r, c, d = e.left, l = e.top, u = e.width, m = e.height, p = R(t),
                            f = O(e, p, n), h = {clip: q(t, f, n, p, e), borders: []};
                        for (i = 0; 4 > i; i++) if (n[i].width > 0) {
                            ...
                            h.borders.push({args: c, color: n[i].color})
                        }
                        return h
                    }
                    ...
                    function W(t, e, n, i) {
                        var o = Math.round(i.left + n.left), s = Math.round(i.top + n.top);
                    ...
                    function V(t, e, n, i, o) {
                        var s = d.Util.BackgroundSize(t, e, i, o), a = d.Util.BackgroundPosition(t, e, i, o, s),
                        ...
                        switch (i = X(i, s), r = r[o] || r[0]) {
                            ...
                            case"no-repeat":
                                ...
                                break;
                            default:
                                W(n, i, a, {top: e.top, left: e.left, width: i.width, height: i.height})
                        }
                    }
                    ...
                    function J(t, e, n) {
                        for (var o, s = ue(t, "backgroundImage"), a = d.Util.parseBackgroundImage(s), r = a.length; r--;) if (s = a[r], s.args && 0 !== s.args.length) {
                            ...
                            o = C(c), o ? V(t, e, n, o, r) : i("html2canvas: Error loading background:", s)
                        }
                    }
                    ...
                    function Y(t, e, n) {
                        var i = s(e ? n.width : c(), e ? n.height : l()), o = {
                            ctx: i,
                        ...
                        return r.useOverflow === !0 && /(hidden|scroll|auto)/.test(ue(t, "overflow")) === !0 && /(BODY)/i.test(t.nodeName) === !1 && (o.clip = o.clip ? S(o.clip, n) : n), o.zIndex.children.push(o), o
                    }
                    ...
                    function te(t, e, n) {
                        var o, s = d.Util.Bounds(t), a = de.test(t.nodeName) ? "#efefef" : ue(t, "backgroundColor"),
                            r = Y(t, e, s), c = r.borders, l = r.ctx, u = Z(c, s, r.clip), m = M(t, s, c);
                        switch (P(l, m.clip), l.save(), l.clip(), u.height > 0 && u.width > 0 && (G(l, s, a), J(t, u, l)), l.restore(), m.borders.forEach(function (t) {
                            U(l, t.args, t.color)
                        }), n || F(t, r), t.nodeName) {
                            case"IMG":
                                (o = C(t.getAttribute("src"))) ? D(l, t, o, s, c) : i("html2canvas: Error loading <img>:" + t.getAttribute("src"));
                                break;
                            case"INPUT":
                                /^(text|url|email|submit|button|reset)$/.test(t.type) && (t.value || t.placeholder).length > 0 && N(t, s, r);
                                break;
                            case"TEXTAREA":
                                (t.value || t.placeholder || "").length > 0 && N(t, s, r);
                                break;
                            case"SELECT":
                                (t.options || t.placeholder || "").length > 0 && N(t, s, r);
                                break;
                            case"LI":
                                T(t, r, u);
                                break;
                    ...
                    function ie(t, e) {
                        function n(t) {
                            var e, i, o, s, r, c = d.Util.Children(t), l = c.length;
                            for (r = 0; l > r; r += 1) if (s = c[r], 3 === s.nodeType) a += s.nodeValue.replace(/</g, "&lt;").replace(/>/g, "&gt;"); else if (1 === s.nodeType && !/^(script|meta|title)$/.test(s.nodeName.toLowerCase())) {
                                if (a += "<" + s.nodeName.toLowerCase(), s.hasAttributes()) for (e = s.attributes, o = e.length, i = 0; o > i; i += 1) a += " " + e[i].name + '="' + e[i].value + '"';
                                a += ">", n(s), a += "</" + s.nodeName.toLowerCase() + ">"
                            }
                        }

                        var i = new Image, o = c(), s = l(), a = "";
                    ...
                    var se = r.elements === n ? e.body : r.elements[0], ae = 0, re = se.ownerDocument,
                        ce = d.Util.Support(r, re), de = new RegExp("(" + r.ignoreElements + ")"), le = re.body,
                        ue = d.Util.getCSS, me = "___html2canvas___pseudoelement", pe = re.createElement("style");
                    ...
                    var fe = function (t) {
                        return function (e, n, i, o) {
                            var s = i * t, a = o * t, r = e + i, c = n + o;
                            return {
                                topLeft: A({x: e, y: c}, {x: e, y: c - a}, {x: r - s, y: n}, {x: r, y: n}),
                                topRight: A({x: e, y: n}, {x: e + s, y: n}, {x: r, y: c - a}, {x: r, y: c}),
                                bottomRight: A({x: r, y: n}, {x: r, y: n + a}, {x: e + s, y: c}, {x: e, y: c}),
                                bottomLeft: A({x: r, y: c}, {x: r - s, y: c}, {x: e, y: n + a}, {x: e, y: n})
                            }
                        }
                    }(4 * ((Math.sqrt(2) - 1) / 3));
                    return oe()
                    ...
                    function r(e, i, s) {
                        var r, c, d = o.proxy;
                        C.href = e, e = C.href, r = "html2canvas_" + y++, s.callbackname = r, d += d.indexOf("?") > -1 ? "&" : "?", d += "url=" + encodeURIComponent(e) + "&callback=" + r, c = $.createElement("script"), t[r] = function (e) {
                    ...
                    function c(e, n) {
                        var i = t.getComputedStyle(e, n), o = i.content;
                    ...
                    function u(t, e) {
                        ...
                        i !== n && (_[t] = {img: i, succeeded: !0}, _.numTotal++, _.numLoaded++, a())
                    }
                    ...
                    var b, g, v, w, _ = {numLoaded: 0, numFailed: 0, numTotal: 0, cleanupDone: !1}, y = 0,
                        x = o.elements[0] || e.body, $ = x.ownerDocument, k = $.images, T = k.length,
                        C = $.createElement("a"), S = function (t) {
                            return t.crossOrigin !== n
                        }(new Image);
                    for (C.href = t.location.href, b = C.protocol + C.host, g = {
                        loadImage: function (e) {
                            var i, a;
                            e && _[e] === n && (i = new Image, e.match(/data:image\/.*;base64,/i) ? (i.src = e.replace(/url\(['"]{0,}|['"]{0,}\)$/gi, ""), a = _[e] = {img: i}, _.numTotal++, h(i, a)) : s(e) || o.allowTaint === !0 ? (a = _[e] = {img: i}, _.numTotal++, h(i, a), i.src = e) : S && !o.allowTaint && o.useCORS ? (i.crossOrigin = "anonymous", a = _[e] = {img: i}, _.numTotal++, h(i, a), i.src = e, i.customComplete = function () {
                                this.img.complete ? this.img.onerror() : this.timer = t.setTimeout(this.img.customComplete, 100)
                            }.bind(a), i.customComplete()) : o.proxy && (a = _[e] = {img: i}, _.numTotal++, r(e, i, a)))
                        }, cleanupDOM: function (s) {
                            var r, c;
                            if (!_.cleanupDone) {
                                i(s && "string" == typeof s ? "html2canvas: Cleanup because: " + s : "html2canvas: Cleanup after timeout: " + o.timeout + " ms.");
                                for (c in _) if (_.hasOwnProperty(c) && (r = _[c], "object" == typeof r && r.callbackname && r.succeeded === n)) {
                                    t[r.callbackname] = n;
                                    try {
                    ...
                    function s(t) {
                        var e;
                        if ("string" == typeof i.renderer && d.Renderer[t] !== n) e = d.Renderer[t](i); else {
                    ...
                    function o() {
                        var t = new Image, o = e.createElement("canvas"),
                ...
                }, t.html2canvas.log = i, t.html2canvas.Renderer = {Canvas: n}, d.Renderer.Canvas = function (t) {
                    function o(t, e) {
    ...
    var i = t("@baidu/webb"), o = t("webb/instance-config").config;
    ...
    return function (t) {
        ...
        function i(t) {
            var e = this, n = t.colno || window.event && window.event.errorCharacter || 0, i = t.error || {},
                s = o.assign({
                    msg: t.message,
                    ln: t.lineno,
                    file: t.filename,
        ...
        e.default = {
            sendBasePfLog: function () {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, e = arguments[1],
                    n = arguments[2], o = window.performance && performance.timing || {}, s = o.navigationStart,
                    a = o.requestStart, r = o.responseStart, c = o.responseEnd, d = o.domComplete, l = o.domLoading,
                    u = o.domainLookupStart, m = o.domainLookupEnd, p = o.connectStart, f = o.connectEnd,
                    h = o.loadEventStart, b = o.loadEventEnd,
                    g = {dns: m - u, tcp: f - p, req: r - a, res: c - r, dct: d - l, ld: b - h},
                    v = window.__webbbrige__ || {}, w = v.whiteScreenTime, _ = v.firstScreenTime;
                w && (g = i.assign(g, {wst: w - s})), _ && (g = i.assign(g, {fst: _ - s})), g = i.assign(g, t), this.send("pf_comm", g, e, null, n)
            }, sendPfLog: function () {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, e = arguments[1],
                    n = arguments[2], o = i.assign({}, t);
        ...
        }(), a = n(0), r = "https://sp1.baidu.com/5b1ZeDe5KgQFm2e88IuM_a/webb.gif";
        ...
        var d = {time: 1, ia: 1, disp_comm: 1, disp_content: 1, et_js: 2, count_comm: 2, dist_comm: 2, pf_comm: 2},
            l = function () {
                ...
                return s(t, [{
                    ...
                    key: "wrapCommonParam", value: function (t, e, n) {
                        var i = {
                    ...
                    key: "hitSample", value: function (t) {
                        var e = this.options[t], n = +(e && e.curSample >= 0 ? e.curSample : this.options.curSample);
                        return this.random <= n
                    }
                }, {
                    key: "getLogHost", value: function (t) {
                        var e = this.options;
                        return e[t] && e[t].logHost || e.logHost ? e[t] && e[t].logHost ? e[t].logHost : e.logHost : 1 === d[t] ? r : c
                    }
                }, {
                    key: "send", value: function (t, e, n, i, o) {
                        if (this.hitSample(t)) {
                    ...
                    key: "sendBeacon", value: function (t, e, n, i) {
                        if (this.hitSample(t)) {
                            var o = this.wrapCommonParam(t, e, n);
                            a.extend(o, i), o && o.ext ? o.ext.path = location.pathname : o && !o.ext && (o.ext = {path: location.pathname}), navigator.sendBeacon ? navigator.sendBeacon(this.getLogHost(t) + "?" + a.stringify(o)) || this.send(t, e, n) : this.send(t, e, n)
                        }
                    }
                }, {
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var o = n(8), s = i(o), a = n(1), r = i(a), c = n(9), d = i(c), l = n(2), u = i(l), m = n(3), p = i(m),
            f = n(4), h = i(f), b = n(5), g = i(b), v = n(6), w = i(v), _ = n(0);
        ...
        function r(t, e) {
            ...
            if (n.sendSwitch || e) {
                ...
                var o = {t1: n.startTime, t2: n.endTime, count: n.count, trigger: i};
        ...
        e.default = {
            initMediaTime: function (t) {
                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = this.__media__ = {
                    dim: e,
                    startTime: 0,
                    endTime: 0,
                    count: 1,
    ...
    var t = navigator.userAgent, e = t.match(/MSIE\s*(\d+)/), n = e && e[1] && +e[1] <= 9;
    n || require(["plugins/swfobject", "soutu/js/tu"], function (t, e) {
        if (/^\/imgsearch/.test(location.pathname)) {
            var n = $("#content_left").find(".result-op"), i = [];
            n.each(function () {
                var t = $(this), e = t.attr("tpl");
                "tu_relate_site" === e && (e += "@" + t.find(".op-tu-relate-site-result").length), i.push(e)
            }), e.log({rsv_imageshow: i.join(":")}), $("#page").hide(), $("#wrapper").outerHeight() < $(document).outerHeight() && $("#foot").addClass("foot_fixed_bottom")
        }
    })
}(), !function () {
    function t(t) {
    ...
    (location.href.match(/voice=1/) || navigator.userAgent.match(/mac os x/i)) && require(["plugins/swfobject", "voice/js/voice"], function (e, n) {
        if (n.log = t, n && n.support()) {
            ...
            i.css("display", "block"), i.click(function () {
                var t = n.init({url: bds.util.domain.get("http://vse.baidu.com") + "/echo.fcgi"});
                t.done(function (t) {
                    t.openUI(), t.onfinish(function (t) {
                        var e = t.content.item[0], n = t && t.result ? t.result.corpus_no : "";
                        changeUrl("wd=" + encodeURIComponent(e) + "&rsv_voice=1&hsug_mtype=2&rsv_vcorpus=" + encodeURIComponent(n)), bds.comm.lastVoiceQuery = e
                    }), n.log({q: "resolve"})
                }).fail(function () {
                    n.log({q: "reject"}), alert("不能获得麦克风的权限")
                }), n.log({q: "start"})
            })
        }
    })
